...
const VirtualTerminalWindow: React.FC<{
  ...
  return (
    <div
      className="absolute bg-black bg-opacity-70 border border-slate-700 rounded-lg shadow-2xl overflow-hidden animate-fade-in"
      style={{ width: 320, height: 180, ...style, zIndex }}
    >
