  ...
  return createConnector((config2) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK: createBaseAccountSDK2 } = await import("./dist-H4BK6IYW.js");
...
*/
//# sourceMappingURL=dist-H4BK6IYW.js.map
