...
import {
  ...
  y
} from "./chunk-KOJQJGFV.js";
import "./chunk-Q5AEF23C.js";
  ...
  constructor(options) {
    ...
    const networkControllerClient = {
      ...
      getApprovedCaipNetworksData: async () => new Promise((resolve) => {
        ...
        if (connection?.connector?.id === ConstantsUtil2.AUTH_CONNECTOR_ID) {
          resolve(getEmailCaipNetworks());
        } else if (connection?.connector?.id === ConstantsUtil2.WALLET_CONNECT_CONNECTOR_ID) {
    ...
    const connectionControllerClient = {
      connectWalletConnect: async (onUri) => {
        ...
        if (siweConfig?.options?.enabled && typeof provider?.authenticate === "function") {
          const { SIWEController, getDidChainId, getDidAddress } = await import("./exports-XHGWAJK2.js");
