...
var se = { state: I, subscribe(e) {
  ...
  return new Promise((t) => {
    ...
    if (a.removeWalletConnectDeepLink(), p.setWalletConnectUri(e?.uri), p.setChains(e?.chains), T.reset("ConnectWallet"), s && n) I.open = true, t();
    else {
      const i = setInterval(() => {
        const l = p.state;
...
//# sourceMappingURL=chunk-WKL2GSCD.js.map
