...
import {
  ...
  setColorTheme,
  setThemeVariables
} from "./chunk-OZTDHHA6.js";
import {
  http
} from "./chunk-UYJCZ5HH.js";
import {
  __commonJS,
  __esm,
  __export,
...
var require_sha512 = __commonJS({
  "node_modules/@stablelib/sha512/lib/sha512.js"(exports) {
    ...
    function hashBlocks(wh, wl, hh2, hl, m, pos, len) {
      ...
      while (len >= 128) {
        for (var i3 = 0; i3 < 16; i3++) {
          var j2 = 8 * i3 + pos;
          wh[i3] = binary_1.readUint32BE(m, j2);
          wl[i3] = binary_1.readUint32BE(m, j2 + 4);
        }
        for (var i3 = 0; i3 < 80; i3++) {
          ...
          if (i3 % 16 === 15) {
            for (var j2 = 0; j2 < 16; j2++) {
              ...
              th2 = wh[(j2 + 1) % 16];
              tl = wl[(j2 + 1) % 16];
              h3 = (th2 >>> 1 | tl << 32 - 1) ^ (th2 >>> 8 | tl << 32 - 8) ^ th2 >>> 7;
              ...
              th2 = wh[(j2 + 14) % 16];
              tl = wl[(j2 + 14) % 16];
              h3 = (th2 >>> 19 | tl << 32 - 19) ^ (tl >>> 61 - 32 | th2 << 32 - (61 - 32)) ^ th2 >>> 6;
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function edadd(p2, q2) {
      const a2 = gf2(), b2 = gf2(), c2 = gf2(), d2 = gf2(), e = gf2(), f4 = gf2(), g2 = gf2(), h3 = gf2(), t = gf2();
      sub(a2, p2[1], p2[0]);
      sub(t, q2[1], q2[0]);
      mul(a2, a2, t);
      add(b2, p2[0], p2[1]);
    ...
    function modL(r2, x) {
      ...
      for (i3 = 63; i3 >= 32; --i3) {
        ...
        for (j2 = i3 - 32, k2 = i3 - 12; j2 < k2; ++j2) {
          x[j2] += carry - 16 * x[i3] * L2[j2 - (i3 - 32)];
...
(function(e) {
  (function() {
    ...
    h3 ? n2 = On : o2 && (n2 = self);
    var p2 = !n2.JS_SHA3_NO_COMMON_JS && true && e.exports, b2 = !n2.JS_SHA3_NO_ARRAY_BUFFER && typeof ArrayBuffer < "u", m = "0123456789abcdef".split(""), w3 = [31, 7936, 2031616, 520093696], y6 = [4, 1024, 262144, 67108864], S3 = [1, 256, 65536, 16777216], I = [6, 1536, 393216, 100663296], N = [0, 8, 16, 24], C3 = [1, 0, 32898, 0, 32906, 2147483648, 2147516416, 2147483648, 32907, 0, 2147483649, 0, 2147516545, 2147483648, 32777, 2147483648, 138, 0, 136, 0, 2147516425, 0, 2147483658, 0, 2147516555, 0, 139, 2147483648, 32905, 2147483648, 32771, 2147483648, 32770, 2147483648, 128, 2147483648, 32778, 0, 2147483658, 2147483648, 2147516545, 2147483648, 32896, 2147483648, 2147483649, 0, 2147516424, 2147483648], F = [224, 256, 384, 512], U3 = [128, 256], J2 = ["hex", "buffer", "arrayBuffer", "array", "digest"], Bt = { 128: 168, 256: 136 };
    (n2.JS_SHA3_NO_NODE_JS || !Array.isArray) && (Array.isArray = function(u3) {
      return Object.prototype.toString.call(u3) === "[object Array]";
    }), b2 && (n2.JS_SHA3_NO_ARRAY_BUFFER_IS_VIEW || !ArrayBuffer.isView) && (ArrayBuffer.isView = function(u3) {
      return typeof u3 == "object" && u3.buffer && u3.buffer.constructor === ArrayBuffer;
    });
    for (var G = function(u3, E3, _) {
      return function(B) {
        return new s(u3, E3, u3).update(B)[_]();
      };
    }, H = function(u3, E3, _) {
      return function(B, R2) {
        return new s(u3, E3, R2).update(B)[_]();
      };
    }, z3 = function(u3, E3, _) {
      return function(B, R2, T2, P) {
        return f4["cshake" + u3].update(B, R2, T2, P)[_]();
      };
    }, Pt = function(u3, E3, _) {
      return function(B, R2, T2, P) {
        return f4["kmac" + u3].update(B, R2, T2, P)[_]();
      };
    }, W2 = function(u3, E3, _, B) {
      ...
      var _ = Bt[u3], B = z3(u3, E3, "hex");
      return B.create = function(R2, T2, P) {
        return !T2 && !P ? f4["shake" + u3].create(R2) : new s(u3, E3, R2).bytepad([T2, P], _);
      }, B.update = function(R2, T2, P, O) {
        return B.create(T2, P, O).update(R2);
      }, W2(B, z3, u3, E3);
    }, Vt2 = function(u3, E3) {
      var _ = Bt[u3], B = Pt(u3, E3, "hex");
      return B.create = function(R2, T2, P) {
        return new v2(u3, E3, T2).bytepad(["KMAC", P], _).bytepad([R2], _);
      }, B.update = function(R2, T2, P, O) {
        return B.create(R2, P, O).update(T2);
      }, W2(B, Pt, u3, E3);
    }, A4 = [{ name: "keccak", padding: S3, bits: F, createMethod: Rt }, { name: "sha3", padding: I, bits: F, createMethod: Rt }, { name: "shake", padding: w3, bits: U3, createMethod: Yt }, { name: "cshake", padding: y6, bits: U3, createMethod: Y }, { name: "kmac", padding: y6, bits: U3, createMethod: Vt2 }], f4 = {}, a2 = [], c2 = 0; c2 < A4.length; ++c2) for (var d2 = A4[c2], g2 = d2.bits, x = 0; x < g2.length; ++x) {
    ...
    function s(u3, E3, _) {
      this.blocks = [], this.s = [], this.padding = E3, this.outputBits = _, this.reset = true, this.finalized = false, this.block = 0, this.start = 0, this.blockCount = 1600 - (u3 << 1) >> 5, this.byteCount = this.blockCount << 2, this.outputBlocks = _ >> 5, this.extraBytes = (_ & 31) >> 3;
    ...
    s.prototype.update = function(u3) {
      ...
      if (_ !== "string") {
        if (_ === "object") {
          ...
          if (b2 && u3.constructor === ArrayBuffer) u3 = new Uint8Array(u3);
          else if (!Array.isArray(u3) && (!b2 || !ArrayBuffer.isView(u3))) throw new Error(t);
        } else throw new Error(t);
        E3 = true;
      }
      for (var B = this.blocks, R2 = this.byteCount, T2 = u3.length, P = this.blockCount, O = 0, Ct2 = this.s, D, q2; O < T2; ) {
        if (this.reset) for (this.reset = false, B[0] = this.block, D = 1; D < P + 1; ++D) B[D] = 0;
        if (E3) for (D = this.start; O < T2 && D < R2; ++O) B[D >> 2] |= u3[O] << N[D++ & 3];
        else for (D = this.start; O < T2 && D < R2; ++O) q2 = u3.charCodeAt(O), q2 < 128 ? B[D >> 2] |= q2 << N[D++ & 3] : q2 < 2048 ? (B[D >> 2] |= (192 | q2 >> 6) << N[D++ & 3], B[D >> 2] |= (128 | q2 & 63) << N[D++ & 3]) : q2 < 55296 || q2 >= 57344 ? (B[D >> 2] |= (224 | q2 >> 12) << N[D++ & 3], B[D >> 2] |= (128 | q2 >> 6 & 63) << N[D++ & 3], B[D >> 2] |= (128 | q2 & 63) << N[D++ & 3]) : (q2 = 65536 + ((q2 & 1023) << 10 | u3.charCodeAt(++O) & 1023), B[D >> 2] |= (240 | q2 >> 18) << N[D++ & 3], B[D >> 2] |= (128 | q2 >> 12 & 63) << N[D++ & 3], B[D >> 2] |= (128 | q2 >> 6 & 63) << N[D++ & 3], B[D >> 2] |= (128 | q2 & 63) << N[D++ & 3]);
        if (this.lastByteIndex = D, D >= R2) {
          for (this.start = D - R2, this.block = B[P], D = 0; D < P; ++D) Ct2[D] ^= B[D];
          k2(Ct2), this.reset = true;
        } else this.start = D;
      }
      return this;
    }, s.prototype.encode = function(u3, E3) {
      var _ = u3 & 255, B = 1, R2 = [_];
      for (u3 = u3 >> 8, _ = u3 & 255; _ > 0; ) R2.unshift(_), u3 = u3 >> 8, _ = u3 & 255, ++B;
      ...
      if (E3) B = R2;
        ...
        var P = u3.charCodeAt(T2);
        P < 128 ? B += 1 : P < 2048 ? B += 2 : P < 55296 || P >= 57344 ? B += 3 : (P = 65536 + ((P & 1023) << 10 | u3.charCodeAt(++T2) & 1023), B += 4);
      }
      return B += this.encode(B * 8), this.update(u3), B;
    }, s.prototype.bytepad = function(u3, E3) {
      for (var _ = this.encode(E3), B = 0; B < u3.length; ++B) _ += this.encodeString(u3[B]);
      var R2 = E3 - _ % E3, T2 = [];
      return T2.length = R2, this.update(T2), this;
    }, s.prototype.finalize = function() {
      if (!this.finalized) {
        this.finalized = true;
        var u3 = this.blocks, E3 = this.lastByteIndex, _ = this.blockCount, B = this.s;
        if (u3[E3 >> 2] |= this.padding[E3 & 3], this.lastByteIndex === this.byteCount) for (u3[0] = u3[_], E3 = 1; E3 < _ + 1; ++E3) u3[E3] = 0;
        for (u3[_ - 1] |= 2147483648, E3 = 0; E3 < _; ++E3) B[E3] ^= u3[E3];
        k2(B);
      }
    }, s.prototype.toString = s.prototype.hex = function() {
      this.finalize();
      for (var u3 = this.blockCount, E3 = this.s, _ = this.outputBlocks, B = this.extraBytes, R2 = 0, T2 = 0, P = "", O; T2 < _; ) {
        for (R2 = 0; R2 < u3 && T2 < _; ++R2, ++T2) O = E3[R2], P += m[O >> 4 & 15] + m[O & 15] + m[O >> 12 & 15] + m[O >> 8 & 15] + m[O >> 20 & 15] + m[O >> 16 & 15] + m[O >> 28 & 15] + m[O >> 24 & 15];
        T2 % u3 === 0 && (k2(E3), R2 = 0);
      }
      return B && (O = E3[R2], P += m[O >> 4 & 15] + m[O & 15], B > 1 && (P += m[O >> 12 & 15] + m[O >> 8 & 15]), B > 2 && (P += m[O >> 20 & 15] + m[O >> 16 & 15])), P;
    }, s.prototype.arrayBuffer = function() {
      this.finalize();
      var u3 = this.blockCount, E3 = this.s, _ = this.outputBlocks, B = this.extraBytes, R2 = 0, T2 = 0, P = this.outputBits >> 3, O;
      B ? O = new ArrayBuffer(_ + 1 << 2) : O = new ArrayBuffer(P);
      for (var Ct2 = new Uint32Array(O); T2 < _; ) {
        for (R2 = 0; R2 < u3 && T2 < _; ++R2, ++T2) Ct2[T2] = E3[R2];
        T2 % u3 === 0 && k2(E3);
      }
      ...
      this.finalize();
      for (var u3 = this.blockCount, E3 = this.s, _ = this.outputBlocks, B = this.extraBytes, R2 = 0, T2 = 0, P = [], O, Ct2; T2 < _; ) {
        for (R2 = 0; R2 < u3 && T2 < _; ++R2, ++T2) O = T2 << 2, Ct2 = E3[R2], P[O] = Ct2 & 255, P[O + 1] = Ct2 >> 8 & 255, P[O + 2] = Ct2 >> 16 & 255, P[O + 3] = Ct2 >> 24 & 255;
        T2 % u3 === 0 && k2(E3);
      }
    ...
    var k2 = function(u3) {
      ...
      for (B = 0; B < 48; B += 2) R2 = u3[0] ^ u3[10] ^ u3[20] ^ u3[30] ^ u3[40], T2 = u3[1] ^ u3[11] ^ u3[21] ^ u3[31] ^ u3[41], P = u3[2] ^ u3[12] ^ u3[22] ^ u3[32] ^ u3[42], O = u3[3] ^ u3[13] ^ u3[23] ^ u3[33] ^ u3[43], Ct2 = u3[4] ^ u3[14] ^ u3[24] ^ u3[34] ^ u3[44], D = u3[5] ^ u3[15] ^ u3[25] ^ u3[35] ^ u3[45], q2 = u3[6] ^ u3[16] ^ u3[26] ^ u3[36] ^ u3[46], De2 = u3[7] ^ u3[17] ^ u3[27] ^ u3[37] ^ u3[47], X3 = u3[8] ^ u3[18] ^ u3[28] ^ u3[38] ^ u3[48], Z2 = u3[9] ^ u3[19] ^ u3[29] ^ u3[39] ^ u3[49], E3 = X3 ^ (P << 1 | O >>> 31), _ = Z2 ^ (O << 1 | P >>> 31), u3[0] ^= E3, u3[1] ^= _, u3[10] ^= E3, u3[11] ^= _, u3[20] ^= E3, u3[21] ^= _, u3[30] ^= E3, u3[31] ^= _, u3[40] ^= E3, u3[41] ^= _, E3 = R2 ^ (Ct2 << 1 | D >>> 31), _ = T2 ^ (D << 1 | Ct2 >>> 31), u3[2] ^= E3, u3[3] ^= _, u3[12] ^= E3, u3[13] ^= _, u3[22] ^= E3, u3[23] ^= _, u3[32] ^= E3, u3[33] ^= _, u3[42] ^= E3, u3[43] ^= _, E3 = P ^ (q2 << 1 | De2 >>> 31), _ = O ^ (De2 << 1 | q2 >>> 31), u3[4] ^= E3, u3[5] ^= _, u3[14] ^= E3, u3[15] ^= _, u3[24] ^= E3, u3[25] ^= _, u3[34] ^= E3, u3[35] ^= _, u3[44] ^= E3, u3[45] ^= _, E3 = Ct2 ^ (X3 << 1 | Z2 >>> 31), _ = D ^ (Z2 << 1 | X3 >>> 31), u3[6] ^= E3, u3[7] ^= _, u3[16] ^= E3, u3[17] ^= _, u3[26] ^= E3, u3[27] ^= _, u3[36] ^= E3, u3[37] ^= _, u3[46] ^= E3, u3[47] ^= _, E3 = q2 ^ (R2 << 1 | T2 >>> 31), _ = De2 ^ (T2 << 1 | R2 >>> 31), u3[8] ^= E3, u3[9] ^= _, u3[18] ^= E3, u3[19] ^= _, u3[28] ^= E3, u3[29] ^= _, u3[38] ^= E3, u3[39] ^= _, u3[48] ^= E3, u3[49] ^= _, Fe2 = u3[0], $3 = u3[1], yt = u3[11] << 4 | u3[10] >>> 28, Je2 = u3[10] << 4 | u3[11] >>> 28, at = u3[20] << 3 | u3[21] >>> 29, Ke3 = u3[21] << 3 | u3[20] >>> 29, Ee2 = u3[31] << 9 | u3[30] >>> 23, Se3 = u3[30] << 9 | u3[31] >>> 23, gt = u3[40] << 18 | u3[41] >>> 14, At = u3[41] << 18 | u3[40] >>> 14, lt = u3[2] << 1 | u3[3] >>> 31, ze2 = u3[3] << 1 | u3[2] >>> 31, tt = u3[13] << 12 | u3[12] >>> 20, Te = u3[12] << 12 | u3[13] >>> 20, wt = u3[22] << 10 | u3[23] >>> 22, xt = u3[23] << 10 | u3[22] >>> 22, ut = u3[33] << 13 | u3[32] >>> 19, ht = u3[32] << 13 | u3[33] >>> 19, Ne = u3[42] << 2 | u3[43] >>> 30, Ie = u3[43] << 2 | u3[42] >>> 30, St = u3[5] << 30 | u3[4] >>> 2, Nt = u3[4] << 30 | u3[5] >>> 2, dt = u3[14] << 6 | u3[15] >>> 26, pt = u3[15] << 6 | u3[14] >>> 26, et = u3[25] << 11 | u3[24] >>> 21, rt = u3[24] << 11 | u3[25] >>> 21, Ge3 = u3[34] << 15 | u3[35] >>> 17, Mt = u3[35] << 15 | u3[34] >>> 17, He3 = u3[45] << 29 | u3[44] >>> 3, ct2 = u3[44] << 29 | u3[45] >>> 3, ft = u3[6] << 28 | u3[7] >>> 4, ot = u3[7] << 28 | u3[6] >>> 4, Ve2 = u3[17] << 23 | u3[16] >>> 9, It = u3[16] << 23 | u3[17] >>> 9, Le2 = u3[26] << 25 | u3[27] >>> 7, vt = u3[27] << 25 | u3[26] >>> 7, Ue2 = u3[36] << 21 | u3[37] >>> 11, it = u3[37] << 21 | u3[36] >>> 11, Et2 = u3[47] << 24 | u3[46] >>> 8, Ye2 = u3[46] << 24 | u3[47] >>> 8, Qe = u3[8] << 27 | u3[9] >>> 5, bt2 = u3[9] << 27 | u3[8] >>> 5, qe2 = u3[18] << 20 | u3[19] >>> 12, st = u3[19] << 20 | u3[18] >>> 12, _t = u3[29] << 7 | u3[28] >>> 25, Me3 = u3[28] << 7 | u3[29] >>> 25, mt = u3[38] << 8 | u3[39] >>> 24, je2 = u3[39] << 8 | u3[38] >>> 24, nt = u3[48] << 14 | u3[49] >>> 18, ke2 = u3[49] << 14 | u3[48] >>> 18, u3[0] = Fe2 ^ ~tt & et, u3[1] = $3 ^ ~Te & rt, u3[10] = ft ^ ~qe2 & at, u3[11] = ot ^ ~st & Ke3, u3[20] = lt ^ ~dt & Le2, u3[21] = ze2 ^ ~pt & vt, u3[30] = Qe ^ ~yt & wt, u3[31] = bt2 ^ ~Je2 & xt, u3[40] = St ^ ~Ve2 & _t, u3[41] = Nt ^ ~It & Me3, u3[2] = tt ^ ~et & Ue2, u3[3] = Te ^ ~rt & it, u3[12] = qe2 ^ ~at & ut, u3[13] = st ^ ~Ke3 & ht, u3[22] = dt ^ ~Le2 & mt, u3[23] = pt ^ ~vt & je2, u3[32] = yt ^ ~wt & Ge3, u3[33] = Je2 ^ ~xt & Mt, u3[42] = Ve2 ^ ~_t & Ee2, u3[43] = It ^ ~Me3 & Se3, u3[4] = et ^ ~Ue2 & nt, u3[5] = rt ^ ~it & ke2, u3[14] = at ^ ~ut & He3, u3[15] = Ke3 ^ ~ht & ct2, u3[24] = Le2 ^ ~mt & gt, u3[25] = vt ^ ~je2 & At, u3[34] = wt ^ ~Ge3 & Et2, u3[35] = xt ^ ~Mt & Ye2, u3[44] = _t ^ ~Ee2 & Ne, u3[45] = Me3 ^ ~Se3 & Ie, u3[6] = Ue2 ^ ~nt & Fe2, u3[7] = it ^ ~ke2 & $3, u3[16] = ut ^ ~He3 & ft, u3[17] = ht ^ ~ct2 & ot, u3[26] = mt ^ ~gt & lt, u3[27] = je2 ^ ~At & ze2, u3[36] = Ge3 ^ ~Et2 & Qe, u3[37] = Mt ^ ~Ye2 & bt2, u3[46] = Ee2 ^ ~Ne & St, u3[47] = Se3 ^ ~Ie & Nt, u3[8] = nt ^ ~Fe2 & tt, u3[9] = ke2 ^ ~$3 & Te, u3[18] = He3 ^ ~ft & qe2, u3[19] = ct2 ^ ~ot & st, u3[28] = gt ^ ~lt & dt, u3[29] = At ^ ~ze2 & pt, u3[38] = Et2 ^ ~Qe & yt, u3[39] = Ye2 ^ ~bt2 & Je2, u3[48] = Ne ^ ~St & Ve2, u3[49] = Ie ^ ~Nt & It, u3[0] ^= C3[B], u3[1] ^= C3[B + 1];
    };
    if (p2) e.exports = f4;
    else for (c2 = 0; c2 < a2.length; ++c2) n2[a2[c2]] = f4[a2[c2]];
  })();
})(Pn);
var b0 = Pn.exports;
var y0 = "logger/5.7.0";
    ...
    Object.keys(i3).forEach((b2) => {
      ...
      try {
        if (m instanceof Uint8Array) {
          let w3 = "";
          for (let y6 = 0; y6 < m.length; y6++) w3 += kn[m[y6] >> 4], w3 += kn[m[y6] & 15];
          n2.push(b2 + "=Uint8Array(0x" + w3 + ")");
        } else n2.push(b2 + "=" + JSON.stringify(m));
      } catch {
...
function Ot(e, t) {
  ...
  if (t.allowMissingPrefix && typeof e == "string" && e.substring(0, 2) !== "0x" && (e = "0x" + e), qn(e) && (e = e.toHexString()), Qt(e)) {
    ...
    const i3 = [];
    for (let n2 = 0; n2 < r2.length; n2 += 2) i3.push(parseInt(r2.substring(n2, n2 + 2), 16));
...
(function(e) {
  (function(t, r2) {
    ...
    o2.isBN = function(f4) {
      ...
      if (typeof f4 == "number") return this._initNumber(f4, a2, c2);
      if (typeof f4 == "object") return this._initArray(f4, a2, c2);
      ...
      var g2, x, M2 = 0;
      if (c2 === "be") for (d2 = f4.length - 1, g2 = 0; d2 >= 0; d2 -= 3) x = f4[d2] | f4[d2 - 1] << 8 | f4[d2 - 2] << 16, this.words[g2] |= x << M2 & 67108863, this.words[g2 + 1] = x >>> 26 - M2 & 67108863, M2 += 24, M2 >= 26 && (M2 -= 26, g2++);
      else if (c2 === "le") for (d2 = 0, g2 = 0; d2 < f4.length; d2 += 3) x = f4[d2] | f4[d2 + 1] << 8 | f4[d2 + 2] << 16, this.words[g2] |= x << M2 & 67108863, this.words[g2 + 1] = x >>> 26 - M2 & 67108863, M2 += 24, M2 >= 26 && (M2 -= 26, g2++);
      return this._strip();
    };
    function p2(A4, f4) {
    ...
    o2.prototype._parseHex = function(f4, a2, c2) {
      ...
      for (var d2 = 0; d2 < this.length; d2++) this.words[d2] = 0;
      var g2 = 0, x = 0, M2;
      if (c2 === "be") for (d2 = f4.length - 1; d2 >= a2; d2 -= 2) M2 = b2(f4, a2, d2) << g2, this.words[x] |= M2 & 67108863, g2 >= 18 ? (g2 -= 18, x += 1, this.words[x] |= M2 >>> 26) : g2 += 8;
      else {
        var l = f4.length - a2;
        for (d2 = l % 2 === 0 ? a2 + 1 : a2; d2 < f4.length; d2 += 2) M2 = b2(f4, a2, d2) << g2, this.words[x] |= M2 & 67108863, g2 >= 18 ? (g2 -= 18, x += 1, this.words[x] |= M2 >>> 26) : g2 += 8;
      }
      this._strip();
    };
    ...
    o2.prototype._parseBase = function(f4, a2, c2) {
      ...
      for (var d2 = 0, g2 = 1; g2 <= 67108863; g2 *= a2) d2++;
      d2--, g2 = g2 / a2 | 0;
      for (var x = f4.length - c2, M2 = x % d2, l = Math.min(x, x - M2) + c2, s = 0, v2 = c2; v2 < l; v2 += d2) s = m(f4, v2, v2 + d2, a2), this.imuln(g2), this.words[0] + s < 67108864 ? this.words[0] += s : this._iaddn(s);
      if (M2 !== 0) {
        var k2 = 1;
        for (s = m(f4, v2, f4.length, a2), v2 = 0; v2 < M2; v2++) k2 *= a2;
    ...
    o2.prototype.toString = function(f4, a2) {
      ...
      if (f4 === 16 || f4 === "hex") {
        ...
        for (var d2 = 0, g2 = 0, x = 0; x < this.length; x++) {
          ...
          g2 = M2 >>> 24 - d2 & 16777215, d2 += 2, d2 >= 26 && (d2 -= 26, x--), g2 !== 0 || x !== this.length - 1 ? c2 = S3[6 - l.length] + l + c2 : c2 = l + c2;
        }
        for (g2 !== 0 && (c2 = g2.toString(16) + c2); c2.length % a2 !== 0; ) c2 = "0" + c2;
      ...
      if (f4 === (f4 | 0) && f4 >= 2 && f4 <= 36) {
        ...
        for (k2.negative = 0; !k2.isZero(); ) {
          var u3 = k2.modrn(v2).toString(f4);
          k2 = k2.idivn(v2), k2.isZero() ? c2 = u3 + c2 : c2 = S3[s - u3.length] + u3 + c2;
        }
    ...
    o2.prototype.toArrayLike = function(f4, a2, c2) {
      ...
      if (c2 < f4.length) for (f4[c2++] = d2; c2 < f4.length; ) f4[c2++] = 0;
      ...
      if (c2 >= 0) for (f4[c2--] = d2; c2 >= 0; ) f4[c2--] = 0;
    ...
    o2.prototype.zeroBits = function() {
      ...
      for (var c2 = 0; c2 < a2.length; c2++) this.words[c2] = this.words[c2] & f4.words[c2];
      ...
      for (var d2 = 0; d2 < c2.length; d2++) this.words[d2] = a2.words[d2] ^ c2.words[d2];
      ...
      for (var g2 = 0, x = 0; x < d2.length; x++) a2 = (c2.words[x] | 0) + (d2.words[x] | 0) + g2, this.words[x] = a2 & 67108863, g2 = a2 >>> 26;
      for (; g2 !== 0 && x < c2.length; x++) a2 = (c2.words[x] | 0) + g2, this.words[x] = a2 & 67108863, g2 = a2 >>> 26;
      if (this.length = c2.length, g2 !== 0) this.words[this.length] = g2, this.length++;
      ...
      for (var x = 0, M2 = 0; M2 < g2.length; M2++) a2 = (d2.words[M2] | 0) - (g2.words[M2] | 0) + x, x = a2 >> 26, this.words[M2] = a2 & 67108863;
      for (; x !== 0 && M2 < d2.length; M2++) a2 = (d2.words[M2] | 0) + x, x = a2 >> 26, this.words[M2] = a2 & 67108863;
      if (x === 0 && M2 < d2.length && d2 !== this) for (; M2 < d2.length; M2++) this.words[M2] = d2.words[M2];
    ...
    function U3(A4, f4, a2) {
      ...
      a2.words[0] = M2;
      for (var s = 1; s < c2; s++) {
        for (var v2 = l >>> 26, k2 = l & 67108863, u3 = Math.min(s, f4.length - 1), E3 = Math.max(0, s - A4.length + 1); E3 <= u3; E3++) {
          var _ = s - E3 | 0;
    ...
    var J2 = function(f4, a2, c2) {
      var d2 = f4.words, g2 = a2.words, x = c2.words, M2 = 0, l, s, v2, k2 = d2[0] | 0, u3 = k2 & 8191, E3 = k2 >>> 13, _ = d2[1] | 0, B = _ & 8191, R2 = _ >>> 13, T2 = d2[2] | 0, P = T2 & 8191, O = T2 >>> 13, Ct2 = d2[3] | 0, D = Ct2 & 8191, q2 = Ct2 >>> 13, De2 = d2[4] | 0, X3 = De2 & 8191, Z2 = De2 >>> 13, Fe2 = d2[5] | 0, $3 = Fe2 & 8191, tt = Fe2 >>> 13, Te = d2[6] | 0, et = Te & 8191, rt = Te >>> 13, Ue2 = d2[7] | 0, it = Ue2 & 8191, nt = Ue2 >>> 13, ke2 = d2[8] | 0, ft = ke2 & 8191, ot = ke2 >>> 13, qe2 = d2[9] | 0, st = qe2 & 8191, at = qe2 >>> 13, Ke3 = g2[0] | 0, ut = Ke3 & 8191, ht = Ke3 >>> 13, He3 = g2[1] | 0, ct2 = He3 & 8191, lt = He3 >>> 13, ze2 = g2[2] | 0, dt = ze2 & 8191, pt = ze2 >>> 13, Le2 = g2[3] | 0, vt = Le2 & 8191, mt = Le2 >>> 13, je2 = g2[4] | 0, gt = je2 & 8191, At = je2 >>> 13, Qe = g2[5] | 0, bt2 = Qe & 8191, yt = Qe >>> 13, Je2 = g2[6] | 0, wt = Je2 & 8191, xt = Je2 >>> 13, Ge3 = g2[7] | 0, Mt = Ge3 & 8191, Et2 = Ge3 >>> 13, Ye2 = g2[8] | 0, St = Ye2 & 8191, Nt = Ye2 >>> 13, Ve2 = g2[9] | 0, It = Ve2 & 8191, _t = Ve2 >>> 13;
      c2.negative = f4.negative ^ a2.negative, c2.length = 19, l = Math.imul(u3, ut), s = Math.imul(u3, ht), s = s + Math.imul(E3, ut) | 0, v2 = Math.imul(E3, ht);
      var Me3 = (M2 + l | 0) + ((s & 8191) << 13) | 0;
      M2 = (v2 + (s >>> 13) | 0) + (Me3 >>> 26) | 0, Me3 &= 67108863, l = Math.imul(B, ut), s = Math.imul(B, ht), s = s + Math.imul(R2, ut) | 0, v2 = Math.imul(R2, ht), l = l + Math.imul(u3, ct2) | 0, s = s + Math.imul(u3, lt) | 0, s = s + Math.imul(E3, ct2) | 0, v2 = v2 + Math.imul(E3, lt) | 0;
      var Ee2 = (M2 + l | 0) + ((s & 8191) << 13) | 0;
      M2 = (v2 + (s >>> 13) | 0) + (Ee2 >>> 26) | 0, Ee2 &= 67108863, l = Math.imul(P, ut), s = Math.imul(P, ht), s = s + Math.imul(O, ut) | 0, v2 = Math.imul(O, ht), l = l + Math.imul(B, ct2) | 0, s = s + Math.imul(B, lt) | 0, s = s + Math.imul(R2, ct2) | 0, v2 = v2 + Math.imul(R2, lt) | 0, l = l + Math.imul(u3, dt) | 0, s = s + Math.imul(u3, pt) | 0, s = s + Math.imul(E3, dt) | 0, v2 = v2 + Math.imul(E3, pt) | 0;
      var Se3 = (M2 + l | 0) + ((s & 8191) << 13) | 0;
      M2 = (v2 + (s >>> 13) | 0) + (Se3 >>> 26) | 0, Se3 &= 67108863, l = Math.imul(D, ut), s = Math.imul(D, ht), s = s + Math.imul(q2, ut) | 0, v2 = Math.imul(q2, ht), l = l + Math.imul(P, ct2) | 0, s = s + Math.imul(P, lt) | 0, s = s + Math.imul(O, ct2) | 0, v2 = v2 + Math.imul(O, lt) | 0, l = l + Math.imul(B, dt) | 0, s = s + Math.imul(B, pt) | 0, s = s + Math.imul(R2, dt) | 0, v2 = v2 + Math.imul(R2, pt) | 0, l = l + Math.imul(u3, vt) | 0, s = s + Math.imul(u3, mt) | 0, s = s + Math.imul(E3, vt) | 0, v2 = v2 + Math.imul(E3, mt) | 0;
      var Ne = (M2 + l | 0) + ((s & 8191) << 13) | 0;
      M2 = (v2 + (s >>> 13) | 0) + (Ne >>> 26) | 0, Ne &= 67108863, l = Math.imul(X3, ut), s = Math.imul(X3, ht), s = s + Math.imul(Z2, ut) | 0, v2 = Math.imul(Z2, ht), l = l + Math.imul(D, ct2) | 0, s = s + Math.imul(D, lt) | 0, s = s + Math.imul(q2, ct2) | 0, v2 = v2 + Math.imul(q2, lt) | 0, l = l + Math.imul(P, dt) | 0, s = s + Math.imul(P, pt) | 0, s = s + Math.imul(O, dt) | 0, v2 = v2 + Math.imul(O, pt) | 0, l = l + Math.imul(B, vt) | 0, s = s + Math.imul(B, mt) | 0, s = s + Math.imul(R2, vt) | 0, v2 = v2 + Math.imul(R2, mt) | 0, l = l + Math.imul(u3, gt) | 0, s = s + Math.imul(u3, At) | 0, s = s + Math.imul(E3, gt) | 0, v2 = v2 + Math.imul(E3, At) | 0;
      var Ie = (M2 + l | 0) + ((s & 8191) << 13) | 0;
      M2 = (v2 + (s >>> 13) | 0) + (Ie >>> 26) | 0, Ie &= 67108863, l = Math.imul($3, ut), s = Math.imul($3, ht), s = s + Math.imul(tt, ut) | 0, v2 = Math.imul(tt, ht), l = l + Math.imul(X3, ct2) | 0, s = s + Math.imul(X3, lt) | 0, s = s + Math.imul(Z2, ct2) | 0, v2 = v2 + Math.imul(Z2, lt) | 0, l = l + Math.imul(D, dt) | 0, s = s + Math.imul(D, pt) | 0, s = s + Math.imul(q2, dt) | 0, v2 = v2 + Math.imul(q2, pt) | 0, l = l + Math.imul(P, vt) | 0, s = s + Math.imul(P, mt) | 0, s = s + Math.imul(O, vt) | 0, v2 = v2 + Math.imul(O, mt) | 0, l = l + Math.imul(B, gt) | 0, s = s + Math.imul(B, At) | 0, s = s + Math.imul(R2, gt) | 0, v2 = v2 + Math.imul(R2, At) | 0, l = l + Math.imul(u3, bt2) | 0, s = s + Math.imul(u3, yt) | 0, s = s + Math.imul(E3, bt2) | 0, v2 = v2 + Math.imul(E3, yt) | 0;
      var Wr = (M2 + l | 0) + ((s & 8191) << 13) | 0;
      M2 = (v2 + (s >>> 13) | 0) + (Wr >>> 26) | 0, Wr &= 67108863, l = Math.imul(et, ut), s = Math.imul(et, ht), s = s + Math.imul(rt, ut) | 0, v2 = Math.imul(rt, ht), l = l + Math.imul($3, ct2) | 0, s = s + Math.imul($3, lt) | 0, s = s + Math.imul(tt, ct2) | 0, v2 = v2 + Math.imul(tt, lt) | 0, l = l + Math.imul(X3, dt) | 0, s = s + Math.imul(X3, pt) | 0, s = s + Math.imul(Z2, dt) | 0, v2 = v2 + Math.imul(Z2, pt) | 0, l = l + Math.imul(D, vt) | 0, s = s + Math.imul(D, mt) | 0, s = s + Math.imul(q2, vt) | 0, v2 = v2 + Math.imul(q2, mt) | 0, l = l + Math.imul(P, gt) | 0, s = s + Math.imul(P, At) | 0, s = s + Math.imul(O, gt) | 0, v2 = v2 + Math.imul(O, At) | 0, l = l + Math.imul(B, bt2) | 0, s = s + Math.imul(B, yt) | 0, s = s + Math.imul(R2, bt2) | 0, v2 = v2 + Math.imul(R2, yt) | 0, l = l + Math.imul(u3, wt) | 0, s = s + Math.imul(u3, xt) | 0, s = s + Math.imul(E3, wt) | 0, v2 = v2 + Math.imul(E3, xt) | 0;
      var Xr = (M2 + l | 0) + ((s & 8191) << 13) | 0;
      M2 = (v2 + (s >>> 13) | 0) + (Xr >>> 26) | 0, Xr &= 67108863, l = Math.imul(it, ut), s = Math.imul(it, ht), s = s + Math.imul(nt, ut) | 0, v2 = Math.imul(nt, ht), l = l + Math.imul(et, ct2) | 0, s = s + Math.imul(et, lt) | 0, s = s + Math.imul(rt, ct2) | 0, v2 = v2 + Math.imul(rt, lt) | 0, l = l + Math.imul($3, dt) | 0, s = s + Math.imul($3, pt) | 0, s = s + Math.imul(tt, dt) | 0, v2 = v2 + Math.imul(tt, pt) | 0, l = l + Math.imul(X3, vt) | 0, s = s + Math.imul(X3, mt) | 0, s = s + Math.imul(Z2, vt) | 0, v2 = v2 + Math.imul(Z2, mt) | 0, l = l + Math.imul(D, gt) | 0, s = s + Math.imul(D, At) | 0, s = s + Math.imul(q2, gt) | 0, v2 = v2 + Math.imul(q2, At) | 0, l = l + Math.imul(P, bt2) | 0, s = s + Math.imul(P, yt) | 0, s = s + Math.imul(O, bt2) | 0, v2 = v2 + Math.imul(O, yt) | 0, l = l + Math.imul(B, wt) | 0, s = s + Math.imul(B, xt) | 0, s = s + Math.imul(R2, wt) | 0, v2 = v2 + Math.imul(R2, xt) | 0, l = l + Math.imul(u3, Mt) | 0, s = s + Math.imul(u3, Et2) | 0, s = s + Math.imul(E3, Mt) | 0, v2 = v2 + Math.imul(E3, Et2) | 0;
      var Zr = (M2 + l | 0) + ((s & 8191) << 13) | 0;
      M2 = (v2 + (s >>> 13) | 0) + (Zr >>> 26) | 0, Zr &= 67108863, l = Math.imul(ft, ut), s = Math.imul(ft, ht), s = s + Math.imul(ot, ut) | 0, v2 = Math.imul(ot, ht), l = l + Math.imul(it, ct2) | 0, s = s + Math.imul(it, lt) | 0, s = s + Math.imul(nt, ct2) | 0, v2 = v2 + Math.imul(nt, lt) | 0, l = l + Math.imul(et, dt) | 0, s = s + Math.imul(et, pt) | 0, s = s + Math.imul(rt, dt) | 0, v2 = v2 + Math.imul(rt, pt) | 0, l = l + Math.imul($3, vt) | 0, s = s + Math.imul($3, mt) | 0, s = s + Math.imul(tt, vt) | 0, v2 = v2 + Math.imul(tt, mt) | 0, l = l + Math.imul(X3, gt) | 0, s = s + Math.imul(X3, At) | 0, s = s + Math.imul(Z2, gt) | 0, v2 = v2 + Math.imul(Z2, At) | 0, l = l + Math.imul(D, bt2) | 0, s = s + Math.imul(D, yt) | 0, s = s + Math.imul(q2, bt2) | 0, v2 = v2 + Math.imul(q2, yt) | 0, l = l + Math.imul(P, wt) | 0, s = s + Math.imul(P, xt) | 0, s = s + Math.imul(O, wt) | 0, v2 = v2 + Math.imul(O, xt) | 0, l = l + Math.imul(B, Mt) | 0, s = s + Math.imul(B, Et2) | 0, s = s + Math.imul(R2, Mt) | 0, v2 = v2 + Math.imul(R2, Et2) | 0, l = l + Math.imul(u3, St) | 0, s = s + Math.imul(u3, Nt) | 0, s = s + Math.imul(E3, St) | 0, v2 = v2 + Math.imul(E3, Nt) | 0;
      var $r = (M2 + l | 0) + ((s & 8191) << 13) | 0;
      M2 = (v2 + (s >>> 13) | 0) + ($r >>> 26) | 0, $r &= 67108863, l = Math.imul(st, ut), s = Math.imul(st, ht), s = s + Math.imul(at, ut) | 0, v2 = Math.imul(at, ht), l = l + Math.imul(ft, ct2) | 0, s = s + Math.imul(ft, lt) | 0, s = s + Math.imul(ot, ct2) | 0, v2 = v2 + Math.imul(ot, lt) | 0, l = l + Math.imul(it, dt) | 0, s = s + Math.imul(it, pt) | 0, s = s + Math.imul(nt, dt) | 0, v2 = v2 + Math.imul(nt, pt) | 0, l = l + Math.imul(et, vt) | 0, s = s + Math.imul(et, mt) | 0, s = s + Math.imul(rt, vt) | 0, v2 = v2 + Math.imul(rt, mt) | 0, l = l + Math.imul($3, gt) | 0, s = s + Math.imul($3, At) | 0, s = s + Math.imul(tt, gt) | 0, v2 = v2 + Math.imul(tt, At) | 0, l = l + Math.imul(X3, bt2) | 0, s = s + Math.imul(X3, yt) | 0, s = s + Math.imul(Z2, bt2) | 0, v2 = v2 + Math.imul(Z2, yt) | 0, l = l + Math.imul(D, wt) | 0, s = s + Math.imul(D, xt) | 0, s = s + Math.imul(q2, wt) | 0, v2 = v2 + Math.imul(q2, xt) | 0, l = l + Math.imul(P, Mt) | 0, s = s + Math.imul(P, Et2) | 0, s = s + Math.imul(O, Mt) | 0, v2 = v2 + Math.imul(O, Et2) | 0, l = l + Math.imul(B, St) | 0, s = s + Math.imul(B, Nt) | 0, s = s + Math.imul(R2, St) | 0, v2 = v2 + Math.imul(R2, Nt) | 0, l = l + Math.imul(u3, It) | 0, s = s + Math.imul(u3, _t) | 0, s = s + Math.imul(E3, It) | 0, v2 = v2 + Math.imul(E3, _t) | 0;
    ...
    function Bt(A4, f4, a2) {
      ...
      for (var c2 = 0, d2 = 0, g2 = 0; g2 < a2.length - 1; g2++) {
        ...
        for (var M2 = c2 & 67108863, l = Math.min(g2, f4.length - 1), s = Math.max(0, g2 - A4.length + 1); s <= l; s++) {
          var v2 = g2 - s, k2 = A4.words[v2] | 0, u3 = f4.words[s] | 0, E3 = k2 * u3, _ = E3 & 67108863;
    ...
    o2.prototype.mulTo = function(f4, a2) {
      ...
      if (++d2 < a2.length) for (var g2 = c2.sqr(); d2 < a2.length; d2++, g2 = g2.sqr()) a2[d2] !== 0 && (c2 = c2.mul(g2));
      return c2;
      ...
      if (c2 !== 0) {
        for (g2 = this.length - 1; g2 >= 0; g2--) this.words[g2 + c2] = this.words[g2];
        for (g2 = 0; g2 < c2; g2++) this.words[g2] = 0;
        this.length += c2;
      }
      return this._strip();
      ...
      for (; g2 < this.length - c2; g2++) x = (this.words[g2 + c2] | 0) + M2, M2 = x >> 26, this.words[g2 + c2] = x & 67108863;
      if (M2 === 0) return this._strip();
      for (i3(M2 === -1), M2 = 0, g2 = 0; g2 < this.length; g2++) x = -(this.words[g2] | 0) + M2, M2 = x >> 26, this.words[g2] = x & 67108863;
      ...
      if (a2 !== "mod") {
        ...
        for (var v2 = 0; v2 < s.length; v2++) s.words[v2] = 0;
      }
      var k2 = d2.clone()._ishlnsubmul(g2, 1, l);
      k2.negative === 0 && (d2 = k2, s && (s.words[l] = 1));
      for (var u3 = l - 1; u3 >= 0; u3--) {
        var E3 = (d2.words[g2.length + u3] | 0) * 67108864 + (d2.words[g2.length + u3 - 1] | 0);
        for (E3 = Math.min(E3 / x | 0, 67108863), d2._ishlnsubmul(g2, E3, u3); d2.negative !== 0; ) E3--, d2.negative = 0, d2._ishlnsubmul(g2, 1, u3), d2.isZero() || (d2.negative ^= 1);
        s && (s.words[u3] = E3);
      }
      ...
      for (var c2 = (1 << 26) % f4, d2 = 0, g2 = this.length - 1; g2 >= 0; g2--) d2 = (c2 * d2 + (this.words[g2] | 0)) % f4;
      return a2 ? -d2 : d2;
      ...
      for (var d2 = new o2(1), g2 = new o2(0), x = new o2(0), M2 = new o2(1), l = 0; a2.isEven() && c2.isEven(); ) a2.iushrn(1), c2.iushrn(1), ++l;
      for (var s = c2.clone(), v2 = a2.clone(); !a2.isZero(); ) {
        for (var k2 = 0, u3 = 1; !(a2.words[0] & u3) && k2 < 26; ++k2, u3 <<= 1) ;
        if (k2 > 0) for (a2.iushrn(k2); k2-- > 0; ) (d2.isOdd() || g2.isOdd()) && (d2.iadd(s), g2.isub(v2)), d2.iushrn(1), g2.iushrn(1);
        for (var E3 = 0, _ = 1; !(c2.words[0] & _) && E3 < 26; ++E3, _ <<= 1) ;
        if (E3 > 0) for (c2.iushrn(E3); E3-- > 0; ) (x.isOdd() || M2.isOdd()) && (x.iadd(s), M2.isub(v2)), x.iushrn(1), M2.iushrn(1);
      ...
      for (var d2 = new o2(1), g2 = new o2(0), x = c2.clone(); a2.cmpn(1) > 0 && c2.cmpn(1) > 0; ) {
        ...
        if (M2 > 0) for (a2.iushrn(M2); M2-- > 0; ) d2.isOdd() && d2.iadd(x), d2.iushrn(1);
        for (var s = 0, v2 = 1; !(c2.words[0] & v2) && s < 26; ++s, v2 <<= 1) ;
        if (s > 0) for (c2.iushrn(s); s-- > 0; ) g2.isOdd() && g2.iadd(x), g2.iushrn(1);
      ...
      for (var d2 = 0; a2.isEven() && c2.isEven(); d2++) a2.iushrn(1), c2.iushrn(1);
      do {
        ...
        if (g2 < 0) {
          var x = a2;
          a2 = c2, c2 = x;
        } else if (g2 === 0 || c2.cmpn(1) === 0) break;
        a2.isub(c2);
      } while (true);
      return c2.iushln(d2);
      ...
      i3(typeof f4 == "number");
      var a2 = f4 % 26, c2 = (f4 - a2) / 26, d2 = 1 << a2;
      if (this.length <= c2) return this._expand(c2 + 1), this.words[c2] |= d2, this;
    ...
    n2(Pt, z3), Pt.prototype.split = function(f4, a2) {
      for (var c2 = 4194303, d2 = Math.min(f4.length, 9), g2 = 0; g2 < d2; g2++) a2.words[g2] = f4.words[g2];
    ...
    n2(Yt, z3), Yt.prototype.imulK = function(f4) {
      ...
      if (H[f4]) return H[f4];
      var a2;
      if (f4 === "k256") a2 = new Pt();
      else if (f4 === "p224") a2 = new W2();
      else if (f4 === "p192") a2 = new Rt();
      else if (f4 === "p25519") a2 = new Yt();
    ...
    Y.prototype._verify1 = function(f4) {
      ...
      for (var v2 = this.pow(s, d2), k2 = this.pow(f4, d2.addn(1).iushrn(1)), u3 = this.pow(f4, d2), E3 = g2; u3.cmp(x) !== 0; ) {
        for (var _ = u3, B = 0; _.cmp(x) !== 0; B++) _ = _.redSqr();
        i3(B < E3);
        var R2 = this.pow(v2, new o2(1).iushln(E3 - B - 1));
        k2 = k2.redMul(R2), v2 = R2.redSqr(), u3 = u3.redMul(v2), E3 = B;
      }
      return k2;
      ...
      for (var g2 = 2; g2 < d2.length; g2++) d2[g2] = this.mul(d2[g2 - 1], f4);
      var x = d2[0], M2 = 0, l = 0, s = a2.bitLength() % 26;
      for (s === 0 && (s = 26), g2 = a2.length - 1; g2 >= 0; g2--) {
        for (var v2 = a2.words[g2], k2 = s - 1; k2 >= 0; k2--) {
          var u3 = v2 >> k2 & 1;
          if (x !== d2[0] && (x = this.sqr(x)), u3 === 0 && M2 === 0) {
            l = 0;
            continue;
          }
          M2 <<= 1, M2 |= u3, l++, !(l !== c2 && (g2 !== 0 || k2 !== 0)) && (x = this.mul(x, d2[M2]), l = 0, M2 = 0);
        }
        s = 26;
      }
      return x;
...
function q0(e) {
  ...
  for (let H = 1; H < i3; H++) o2.push(n2 += r2());
  let h3 = r2(), p2 = t;
  t += h3;
  let b2 = 0, m = 0;
  function w3() {
  ...
  const y6 = 31, S3 = Math.pow(2, y6), I = S3 >>> 1, N = I >> 1, C3 = S3 - 1;
  let F = 0;
  for (let H = 0; H < y6; H++) F = F << 1 | w3();
  let U3 = [], J2 = 0, Bt = S3;
  for (; ; ) {
    ...
    for (; !((W2 ^ Rt) & I); ) F = F << 1 & C3 | w3(), W2 = W2 << 1 & C3, Rt = Rt << 1 & C3 | 1;
    for (; W2 & ~Rt & N; ) F = F & I | F << 1 & C3 >>> 1 | w3(), W2 = W2 << 1 ^ I, Rt = (Rt ^ I) << 1 | I | 1;
    J2 = W2, Bt = 1 + Rt - W2;
  }
  let G = i3 - 4;
  return U3.map((H) => {
...
function L0(e, t) {
  let r2 = Array(e);
  for (let i3 = 0; i3 < e; i3++) r2[i3] = 1 + t();
  return r2;
}
function rf(e, t) {
  let r2 = Array(e);
  for (let i3 = 0, n2 = -1; i3 < e; i3++) r2[i3] = n2 += 1 + t();
  return r2;
}
function j0(e, t) {
  let r2 = Array(e);
  for (let i3 = 0, n2 = 0; i3 < e; i3++) r2[i3] = n2 += z0(t());
  return r2;
}
function Pr(e, t) {
  let r2 = rf(e(), e), i3 = e(), n2 = rf(i3, e), o2 = L0(i3, e);
  for (let h3 = 0; h3 < i3; h3++) for (let p2 = 0; p2 < o2[h3]; p2++) r2.push(n2[h3] + p2);
...
function nf(e, t, r2) {
  ...
  for (let n2 = 0; n2 < t; n2++) j0(e, r2).forEach((o2, h3) => i3[h3].push(o2));
  return i3;
}
function G0(e, t) {
  ...
  return ef(o2.map((h3, p2) => {
    ...
    return Array(n2[p2]).fill(void 0).map((w3, y6) => {
      let S3 = y6 * i3;
      return [b2 + y6 * r2, m.map((I) => I + S3)];
    });
  }));
}
function Y0(e, t) {
...
function V0(e) {
  ...
  function r2() {
    ...
    i3.sort((m, w3) => w3.set.size - m.set.size);
    let n2 = e(), o2 = n2 % 3;
    n2 = n2 / 3 | 0;
    let h3 = !!(n2 & 1);
    n2 >>= 1;
...
function ls(e, t) {
  ...
  } else for (var i3 = 0, n2 = 0; n2 < e.length; n2++) {
...
function _s(e, t, r2, i3, n2, o2, h3, p2, b2, m) {
  var w3 = 0, y6 = t;
  y6 = y6 + i3 >>> 0, w3 += y6 < t ? 1 : 0, y6 = y6 + o2 >>> 0, w3 += y6 < o2 ? 1 : 0, y6 = y6 + p2 >>> 0, w3 += y6 < p2 ? 1 : 0, y6 = y6 + m >>> 0, w3 += y6 < m ? 1 : 0;
  var S3 = e + r2 + n2 + h3 + b2 + w3;
  return S3 >>> 0;
}
Q.sum64_5_hi = _s;
...
function Ts(e, t, r2, i3) {
  if (e === 0) return df(t, r2, i3);
  if (e === 1 || e === 3) return vf(t, r2, i3);
  if (e === 2) return pf(t, r2, i3);
}
ae.ft_1 = Ts;
function df(e, t, r2) {
  return e & t ^ ~e & r2;
...
he.blockSize = 512, he.outSize = 160, he.hmacStrength = 80, he.padLength = 64, he.prototype._update = function(t, r2) {
  for (var i3 = this.W, n2 = 0; n2 < 16; n2++) i3[n2] = t[r2 + n2];
  for (; n2 < i3.length; n2++) i3[n2] = _i(i3[n2 - 3] ^ i3[n2 - 8] ^ i3[n2 - 14] ^ i3[n2 - 16], 1);
  var o2 = this.h[0], h3 = this.h[1], p2 = this.h[2], b2 = this.h[3], m = this.h[4];
  for (n2 = 0; n2 < i3.length; n2++) {
    var w3 = ~~(n2 / 20), y6 = Ls(_i(o2, 5), js(w3, h3, p2, b2), m, i3[n2], Qs[w3]);
    m = b2, b2 = p2, p2 = _i(h3, 30), h3 = o2, o2 = y6;
  }
...
ce.blockSize = 512, ce.outSize = 256, ce.hmacStrength = 192, ce.padLength = 64, ce.prototype._update = function(t, r2) {
  for (var i3 = this.W, n2 = 0; n2 < 16; n2++) i3[n2] = t[r2 + n2];
  for (; n2 < i3.length; n2++) i3[n2] = Vs(ra(i3[n2 - 2]), i3[n2 - 7], ea(i3[n2 - 15]), i3[n2 - 16]);
  var o2 = this.h[0], h3 = this.h[1], p2 = this.h[2], b2 = this.h[3], m = this.h[4], w3 = this.h[5], y6 = this.h[6], S3 = this.h[7];
  for (Ys(this.k.length === i3.length), n2 = 0; n2 < i3.length; n2++) {
    var I = Ws(S3, ta(m), Xs(m, w3, y6), this.k[n2], i3[n2]), N = ie($s(o2), Zs(o2, h3, p2));
    S3 = y6, y6 = w3, w3 = m, m = ie(b2, I), b2 = p2, p2 = h3, h3 = o2, o2 = ie(I, N);
  }
  this.h[0] = ie(this.h[0], o2), this.h[1] = ie(this.h[1], h3), this.h[2] = ie(this.h[2], p2), this.h[3] = ie(this.h[3], b2), this.h[4] = ie(this.h[4], m), this.h[5] = ie(this.h[5], w3), this.h[6] = ie(this.h[6], y6), this.h[7] = ie(this.h[7], S3);
...
ne.blockSize = 1024, ne.outSize = 512, ne.hmacStrength = 192, ne.padLength = 128, ne.prototype._prepareBlock = function(t, r2) {
  for (var i3 = this.W, n2 = 0; n2 < 32; n2++) i3[n2] = t[r2 + n2];
  for (; n2 < i3.length; n2 += 2) {
    var o2 = xa(i3[n2 - 4], i3[n2 - 3]), h3 = Ma(i3[n2 - 4], i3[n2 - 3]), p2 = i3[n2 - 14], b2 = i3[n2 - 13], m = ya(i3[n2 - 30], i3[n2 - 29]), w3 = wa(i3[n2 - 30], i3[n2 - 29]), y6 = i3[n2 - 32], S3 = i3[n2 - 31];
    i3[n2] = sa(o2, h3, p2, b2, m, w3, y6, S3), i3[n2 + 1] = aa(o2, h3, p2, b2, m, w3, y6, S3);
  }
}, ne.prototype._update = function(t, r2) {
  this._prepareBlock(t, r2);
  var i3 = this.W, n2 = this.h[0], o2 = this.h[1], h3 = this.h[2], p2 = this.h[3], b2 = this.h[4], m = this.h[5], w3 = this.h[6], y6 = this.h[7], S3 = this.h[8], I = this.h[9], N = this.h[10], C3 = this.h[11], F = this.h[12], U3 = this.h[13], J2 = this.h[14], Bt = this.h[15];
  oa(this.k.length === i3.length);
  for (var G = 0; G < i3.length; G += 2) {
    var H = J2, z3 = Bt, Pt = Aa(S3, I), W2 = ba(S3, I), Rt = la(S3, I, N, C3, F), Yt = da(S3, I, N, C3, F, U3), Y = this.k[G], Vt2 = this.k[G + 1], A4 = i3[G], f4 = i3[G + 1], a2 = ua(H, z3, Pt, W2, Rt, Yt, Y, Vt2, A4, f4), c2 = ha(H, z3, Pt, W2, Rt, Yt, Y, Vt2, A4, f4);
    H = ma(n2, o2), z3 = ga(n2, o2), Pt = pa(n2, o2, h3, p2, b2), W2 = va(n2, o2, h3, p2, b2, m);
    var d2 = Ci(H, z3, Pt, W2), g2 = Ri(H, z3, Pt, W2);
    J2 = F, Bt = U3, F = N, U3 = C3, N = S3, C3 = I, S3 = Ci(w3, y6, a2, c2), I = Ri(y6, y6, a2, c2), w3 = b2, y6 = m, b2 = h3, m = p2, h3 = n2, p2 = o2, n2 = Ci(a2, c2, d2, g2), o2 = Ri(a2, c2, d2, g2);
  }
  Be(this.h, 0, n2, o2), Be(this.h, 2, h3, p2), Be(this.h, 4, b2, m), Be(this.h, 6, w3, y6), Be(this.h, 8, S3, I), Be(this.h, 10, N, C3), Be(this.h, 12, F, U3), Be(this.h, 14, J2, Bt);
...
Xe.inherits(pe, _f), Sf.ripemd160 = pe, pe.blockSize = 512, pe.outSize = 160, pe.hmacStrength = 192, pe.padLength = 64, pe.prototype._update = function(t, r2) {
  for (var i3 = this.h[0], n2 = this.h[1], o2 = this.h[2], h3 = this.h[3], p2 = this.h[4], b2 = i3, m = n2, w3 = o2, y6 = h3, S3 = p2, I = 0; I < 80; I++) {
    var N = Nf(Tr(If(i3, Bf(I, n2, o2, h3), t[_a[I] + r2], Na(I)), Ca[I]), p2);
    i3 = p2, p2 = h3, h3 = Tr(o2, 10), o2 = n2, n2 = N, N = Nf(Tr(If(b2, Bf(79 - I, m, w3, y6), t[Ba[I] + r2], Ia(I)), Ra[I]), S3), b2 = S3, S3 = y6, y6 = Tr(w3, 10), w3 = m, m = N;
  }
  N = xr(this.h[1], o2, y6), this.h[1] = xr(this.h[2], h3, S3), this.h[2] = xr(this.h[3], p2, b2), this.h[3] = xr(this.h[4], i3, m), this.h[4] = xr(this.h[0], n2, w3), this.h[0] = N;
...
var fe = cr(function(e, t) {
  ...
  function i3(h3, p2) {
    ...
    var b2 = [];
    if (typeof h3 != "string") {
      for (var m = 0; m < h3.length; m++) b2[m] = h3[m] | 0;
      return b2;
    }
    if (p2 === "hex") {
      h3 = h3.replace(/[^a-z0-9]+/ig, ""), h3.length % 2 !== 0 && (h3 = "0" + h3);
      for (var m = 0; m < h3.length; m += 2) b2.push(parseInt(h3[m] + h3[m + 1], 16));
    } else for (var m = 0; m < h3.length; m++) {
      var w3 = h3.charCodeAt(m), y6 = w3 >> 8, S3 = w3 & 255;
      y6 ? b2.push(y6, S3) : b2.push(S3);
    }
    return b2;
  }
  r2.toArray = i3;
  ...
  r2.zero2 = n2;
  function o2(h3) {
    for (var p2 = "", b2 = 0; b2 < h3.length; b2++) p2 += n2(h3[b2].toString(16));
    return p2;
  }
...
var Jt = cr(function(e, t) {
  ...
  function i3(b2, m, w3) {
    var y6 = new Array(Math.max(b2.bitLength(), w3) + 1);
    y6.fill(0);
    for (var S3 = 1 << m + 1, I = b2.clone(), N = 0; N < y6.length; N++) {
      var C3, F = I.andln(S3 - 1);
      I.isOdd() ? (F > (S3 >> 1) - 1 ? C3 = (S3 >> 1) - F : C3 = F, I.isubn(C3)) : C3 = 0, y6[N] = C3, I.iushrn(1);
    }
    return y6;
  }
  r2.getNAF = i3;
  function n2(b2, m) {
    ...
    for (var y6 = 0, S3 = 0, I; b2.cmpn(-y6) > 0 || m.cmpn(-S3) > 0; ) {
      var N = b2.andln(3) + y6 & 3, C3 = m.andln(3) + S3 & 3;
      N === 3 && (N = -1), C3 === 3 && (C3 = -1);
      var F;
      N & 1 ? (I = b2.andln(7) + y6 & 7, (I === 3 || I === 5) && C3 === 2 ? F = -N : F = N) : F = 0, w3[0].push(F);
      var U3;
      C3 & 1 ? (I = m.andln(7) + S3 & 7, (I === 3 || I === 5) && N === 2 ? U3 = -C3 : U3 = C3) : U3 = 0, w3[1].push(U3), 2 * y6 === F + 1 && (y6 = 1 - y6), 2 * S3 === U3 + 1 && (S3 = 1 - S3), b2.iushrn(1), m.iushrn(1);
    }
    return w3;
  }
  r2.getJSF = n2;
  function o2(b2, m, w3) {
    ...
    b2.prototype[m] = function() {
      return this[y6] !== void 0 ? this[y6] : this[y6] = w3.call(this);
    };
  }
...
Ce.prototype.point = function() {
  ...
  for (p2 = 0; p2 < n2.length; p2 += i3.step) {
    b2 = 0;
    for (var m = p2 + i3.step - 1; m >= p2; m--) b2 = (b2 << 1) + n2[m];
    h3.push(b2);
  }
  for (var w3 = this.jpoint(null, null, null), y6 = this.jpoint(null, null, null), S3 = o2; S3 > 0; S3--) {
    for (p2 = 0; p2 < h3.length; p2++) b2 = h3[p2], b2 === S3 ? y6 = y6.mixedAdd(i3.points[p2]) : b2 === -S3 && (y6 = y6.mixedAdd(i3.points[p2].neg()));
    w3 = w3.add(y6);
  }
  return w3.toP();
  ...
  for (var o2 = n2.points, h3 = Ur(r2, i3, this._bitLength), p2 = this.jpoint(null, null, null), b2 = h3.length - 1; b2 >= 0; b2--) {
    for (var m = 0; b2 >= 0 && h3[b2] === 0; b2--) m++;
    if (b2 >= 0 && m++, p2 = p2.dblp(m), b2 < 0) break;
    var w3 = h3[b2];
    kr(w3 !== 0), t.type === "affine" ? w3 > 0 ? p2 = p2.mixedAdd(o2[w3 - 1 >> 1]) : p2 = p2.mixedAdd(o2[-w3 - 1 >> 1].neg()) : w3 > 0 ? p2 = p2.add(o2[w3 - 1 >> 1]) : p2 = p2.add(o2[-w3 - 1 >> 1].neg());
  }
  return t.type === "affine" ? p2.toP() : p2;
}, Ce.prototype._wnafMulAdd = function(t, r2, i3, n2, o2) {
  var h3 = this._wnafT1, p2 = this._wnafT2, b2 = this._wnafT3, m = 0, w3, y6, S3;
  for (w3 = 0; w3 < n2; w3++) {
    S3 = r2[w3];
    var I = S3._getNAFPoints(t);
    h3[w3] = I.wnd, p2[w3] = I.points;
  }
  for (w3 = n2 - 1; w3 >= 1; w3 -= 2) {
    ...
    for (m = Math.max(J2[0].length, m), b2[N] = new Array(m), b2[C3] = new Array(m), y6 = 0; y6 < m; y6++) {
      var Bt = J2[0][y6] | 0, G = J2[1][y6] | 0;
      b2[N][y6] = U3[(Bt + 1) * 3 + (G + 1)], b2[C3][y6] = 0, p2[N] = F;
    }
  }
  ...
  for (w3 = m; w3 >= 0; w3--) {
    for (var Pt = 0; w3 >= 0; ) {
      var W2 = true;
      for (y6 = 0; y6 < n2; y6++) z3[y6] = b2[y6][w3] | 0, z3[y6] !== 0 && (W2 = false);
      if (!W2) break;
      Pt++, w3--;
    }
    if (w3 >= 0 && Pt++, H = H.dblp(Pt), w3 < 0) break;
    for (y6 = 0; y6 < n2; y6++) {
      var Rt = z3[y6];
      Rt !== 0 && (Rt > 0 ? S3 = p2[y6][Rt - 1 >> 1] : Rt < 0 && (S3 = p2[y6][-Rt - 1 >> 1].neg()), S3.type === "affine" ? H = H.mixedAdd(S3) : H = H.add(S3));
    }
  }
  for (w3 = 0; w3 < n2; w3++) p2[w3] = null;
  return o2 ? H : H.toP();
};
function Xt(e, t) {
...
Ce.BasePoint = Xt, Xt.prototype.eq = function() {
  ...
  for (var r2 = [this], i3 = (1 << t) - 1, n2 = i3 === 1 ? null : this.dbl(), o2 = 1; o2 < i3; o2++) r2[o2] = r2[o2 - 1].add(n2);
...
Zt.prototype._getEndomorphism = function(t) {
  ...
  for (var r2 = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), i3 = t, n2 = this.n.clone(), o2 = new K(1), h3 = new K(0), p2 = new K(0), b2 = new K(1), m, w3, y6, S3, I, N, C3, F = 0, U3, J2; i3.cmpn(0) !== 0; ) {
    var Bt = n2.div(i3);
    U3 = n2.sub(Bt.mul(i3)), J2 = p2.sub(Bt.mul(o2));
    var G = b2.sub(Bt.mul(h3));
    if (!y6 && U3.cmp(r2) < 0) m = C3.neg(), w3 = o2, y6 = U3.neg(), S3 = J2;
    else if (y6 && ++F === 2) break;
    C3 = U3, n2 = i3, i3 = U3, p2 = o2, o2 = J2, b2 = h3, h3 = G;
  }
  I = U3.neg(), N = J2;
  var H = y6.sqr().add(S3.sqr()), z3 = I.sqr().add(N.sqr());
  return z3.cmp(H) >= 0 && (I = m, N = w3), y6.negative && (y6 = y6.neg(), S3 = S3.neg()), I.negative && (I = I.neg(), N = N.neg()), [{ a: y6, b: S3 }, { a: I, b: N }];
}, Zt.prototype._endoSplit = function(t) {
  var r2 = this.endo.basis, i3 = r2[0], n2 = r2[1], o2 = n2.b.mul(t).divRound(this.n), h3 = i3.b.neg().mul(t).divRound(this.n), p2 = o2.mul(i3.a), b2 = h3.mul(n2.a), m = o2.mul(i3.b), w3 = h3.mul(n2.b), y6 = t.sub(p2).sub(b2), S3 = m.add(w3).neg();
  return { k1: y6, k2: S3 };
  ...
  if (n2.redSqr().redSub(i3).cmp(this.zero) !== 0) throw new Error("invalid point");
  ...
  for (var w3 = this._wnafMulAdd(1, n2, o2, h3 * 2, i3), y6 = 0; y6 < h3 * 2; y6++) n2[y6] = null, o2[y6] = null;
  return w3;
};
...
Di(Tt, Ze.BasePoint), Zt.prototype.jpoint = function(t, r2, i3) {
  ...
  if (b2.cmpn(0) === 0) return m.cmpn(0) !== 0 ? this.curve.jpoint(null, null, null) : this.dbl();
  var w3 = b2.redSqr(), y6 = w3.redMul(b2), S3 = n2.redMul(w3), I = m.redSqr().redIAdd(y6).redISub(S3).redISub(S3), N = m.redMul(S3.redISub(I)).redISub(h3.redMul(y6)), C3 = this.z.redMul(t.z).redMul(b2);
  ...
  var m = p2.redSqr(), w3 = m.redMul(p2), y6 = i3.redMul(m), S3 = b2.redSqr().redIAdd(w3).redISub(y6).redISub(y6), I = b2.redMul(y6.redISub(S3)).redISub(o2.redMul(w3)), N = this.z.redMul(p2);
  return this.curve.jpoint(S3, I, N);
  ...
  var n2 = this.curve.a, o2 = this.curve.tinv, h3 = this.x, p2 = this.y, b2 = this.z, m = b2.redSqr().redSqr(), w3 = p2.redAdd(p2);
  for (r2 = 0; r2 < t; r2++) {
    var y6 = h3.redSqr(), S3 = w3.redSqr(), I = S3.redSqr(), N = y6.redAdd(y6).redIAdd(y6).redIAdd(n2.redMul(m)), C3 = h3.redMul(S3), F = N.redSqr().redISub(C3.redAdd(C3)), U3 = C3.redISub(F), J2 = N.redMul(U3);
    J2 = J2.redIAdd(J2).redISub(I);
    var Bt = w3.redMul(b2);
    r2 + 1 < t && (m = m.redMul(I)), h3 = F, b2 = Bt, w3 = J2;
  }
  return this.curve.jpoint(h3, w3.redMul(o2), b2);
  ...
  if (this.zOne) {
    ...
    p2 = p2.redIAdd(p2);
    var b2 = n2.redAdd(n2).redIAdd(n2), m = b2.redSqr().redISub(p2).redISub(p2), w3 = h3.redIAdd(h3);
    w3 = w3.redIAdd(w3), w3 = w3.redIAdd(w3), t = m, r2 = b2.redMul(p2.redISub(m)).redISub(w3), i3 = this.y.redAdd(this.y);
  } else {
    var y6 = this.x.redSqr(), S3 = this.y.redSqr(), I = S3.redSqr(), N = this.x.redAdd(S3).redSqr().redISub(y6).redISub(I);
    N = N.redIAdd(N);
    var C3 = y6.redAdd(y6).redIAdd(y6), F = C3.redSqr(), U3 = I.redIAdd(I);
  ...
  if (this.zOne) {
    ...
    w3 = w3.redIAdd(w3), w3 = w3.redIAdd(w3), r2 = b2.redMul(p2.redISub(m)).redISub(w3), i3 = this.y.redAdd(this.y);
  } else {
    var y6 = this.z.redSqr(), S3 = this.y.redSqr(), I = this.x.redMul(S3), N = this.x.redSub(y6).redMul(this.x.redAdd(y6));
    N = N.redAdd(N).redIAdd(N);
    var C3 = I.redIAdd(I);
    C3 = C3.redIAdd(C3);
    var F = C3.redAdd(C3);
    t = N.redSqr().redISub(F), i3 = this.y.redAdd(this.z).redSqr().redISub(S3).redISub(y6);
    var U3 = S3.redSqr();
  ...
  m = m.redIAdd(m);
  var w3 = m.redMul(p2), y6 = b2.redSqr().redISub(w3.redAdd(w3)), S3 = w3.redISub(y6), I = p2.redSqr();
  I = I.redIAdd(I), I = I.redIAdd(I), I = I.redIAdd(I);
  var N = b2.redMul(S3).redISub(I), C3 = i3.redAdd(i3).redMul(n2);
  return this.curve.jpoint(y6, N, C3);
  ...
  var w3 = o2.redIAdd(p2).redSqr().redISub(h3).redISub(b2).redISub(m), y6 = r2.redMul(w3);
  y6 = y6.redIAdd(y6), y6 = y6.redIAdd(y6);
  var S3 = this.x.redMul(b2).redISub(y6);
  S3 = S3.redIAdd(S3), S3 = S3.redIAdd(S3);
  var I = this.y.redMul(w3.redMul(m.redISub(w3)).redISub(p2.redMul(b2)));
  I = I.redIAdd(I), I = I.redIAdd(I), I = I.redIAdd(I);
...
function Ui(e, t) {
  ...
  for (var n2 = 0, o2 = 0, h3 = t.place; o2 < i3; o2++, h3++) n2 <<= 8, n2 |= e[h3], n2 >>>= 0;
...
Hr.prototype._importDER = function(t, r2) {
  ...
  var n2 = Ui(t, i3);
  if (n2 === false || n2 + i3.place !== t.length || t[i3.place++] !== 2) return false;
  var o2 = Ui(t, i3);
  if (o2 === false) return false;
  var h3 = t.slice(i3.place, o2 + i3.place);
  if (i3.place += o2, t[i3.place++] !== 2) return false;
  var p2 = Ui(t, i3);
  if (p2 === false || t.length !== p2 + i3.place) return false;
...
$t.prototype.keyPair = function(t) {
  ...
  for (var o2 = this.n.byteLength(), h3 = r2.getPrivate().toArray("be", o2), p2 = t.toArray("be", o2), b2 = new Rf({ hash: this.hash, entropy: h3, nonce: p2, pers: n2.pers, persEnc: n2.persEnc || "utf8" }), m = this.n.sub(new K(1)), w3 = 0; ; w3++) {
    var y6 = n2.k ? n2.k(w3) : new K(b2.generate(this.n.byteLength()));
    if (y6 = this._truncateToN(y6, true), !(y6.cmpn(1) <= 0 || y6.cmp(m) >= 0)) {
      var S3 = this.g.mul(y6);
      if (!S3.isInfinity()) {
        var I = S3.getX(), N = I.umod(this.n);
        if (N.cmpn(0) !== 0) {
          var C3 = y6.invm(this.n).mul(N.mul(r2.getPrivate()).iadd(t));
          if (C3 = C3.umod(this.n), C3.cmpn(0) !== 0) {
            var F = (S3.getY().isOdd() ? 1 : 0) | (I.cmp(N) !== 0 ? 2 : 0);
  ...
  var p2 = h3.invm(this.n), b2 = p2.mul(t).umod(this.n), m = p2.mul(o2).umod(this.n), w3;
  return this.curve._maxwellTrick ? (w3 = this.g.jmulAdd(b2, i3.getPublic(), m), w3.isInfinity() ? false : w3.eqXToP(o2)) : (w3 = this.g.mulAdd(b2, i3.getPublic(), m), w3.isInfinity() ? false : w3.getX().umod(this.n).cmp(o2) === 0);
  ...
  if (h3.cmp(this.curve.p.umod(this.curve.n)) >= 0 && m) throw new Error("Unable to find sencond key candinate");
  m ? h3 = this.curve.pointFromX(h3.add(this.curve.n), b2) : h3 = this.curve.pointFromX(h3, b2);
  var w3 = t.r.invm(n2), y6 = n2.sub(o2).mul(w3).umod(n2), S3 = p2.mul(w3).umod(n2);
  return this.g.mulAdd(y6, h3, S3);
...
function Hi(o2, e) {
  ...
  function g2(u3) {
    ...
    for (var p2 = 0, T2 = 0, D = 0, P = u3.length; D !== P && u3[D] === 0; ) D++, p2++;
    for (var x = (P - D) * d2 + 1 >>> 0, w3 = new Uint8Array(x); D !== P; ) {
      for (var O = u3[D], N = 0, _ = x - 1; (O !== 0 || N < T2) && _ !== -1; _--, N++) O += 256 * w3[_] >>> 0, w3[_] = O % a2 >>> 0, O = O / a2 >>> 0;
      if (O !== 0) throw new Error("Non-zero carry");
      T2 = N, D++;
    }
    for (var A4 = x - T2; A4 !== x && w3[A4] === 0; ) A4++;
    for (var G = h3.repeat(p2); A4 < x; ++A4) G += o2.charAt(w3[A4]);
    return G;
  }
  function m(u3) {
    ...
    var p2 = 0;
    if (u3[p2] !== " ") {
      for (var T2 = 0, D = 0; u3[p2] === h3; ) T2++, p2++;
      for (var P = (u3.length - p2) * l + 1 >>> 0, x = new Uint8Array(P); u3[p2]; ) {
        var w3 = t[u3.charCodeAt(p2)];
        if (w3 === 255) return;
        for (var O = 0, N = P - 1; (w3 !== 0 || O < D) && N !== -1; N--, O++) w3 += a2 * x[N] >>> 0, x[N] = w3 % 256 >>> 0, w3 = w3 / 256 >>> 0;
        if (w3 !== 0) throw new Error("Non-zero carry");
        D = O, p2++;
      }
      if (u3[p2] !== " ") {
        for (var _ = P - D; _ !== P && x[_] === 0; ) _++;
        for (var A4 = new Uint8Array(T2 + (P - _)), G = T2; _ !== P; ) A4[G++] = x[_++];
        return A4;
      }
    }
  }
...
var ss2 = (o2, e, t, i3) => {
  const s = {};
  for (let d2 = 0; d2 < e.length; ++d2) s[e[d2]] = d2;
  let r2 = o2.length;
  for (; o2[r2 - 1] === "="; ) --r2;
...
var rs2 = (o2, e, t) => {
  ...
  let r2 = "", n2 = 0, a2 = 0;
  for (let h3 = 0; h3 < o2.length; ++h3) for (a2 = a2 << 8 | o2[h3], n2 += 8; n2 > t; ) n2 -= t, r2 += e[s & a2 >> n2];
  if (n2 && (r2 += e[s & a2 << t - n2]), i3) for (; r2.length * t & 7; ) r2 += "=";
  return r2;
};
var y4 = ({ name: o2, prefix: e, bitsPerChar: t, alphabet: i3 }) => Q2({ prefix: e, name: o2, encode(s) {
  return rs2(s, i3, t);
}, decode(s) {
...
var as2 = y4({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
var hs2 = Object.freeze({ __proto__: null, base2: as2 });
var cs2 = y4({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 });
...
var gs2 = y4({ prefix: "f", name: "base16", alphabet: "0123456789abcdef", bitsPerChar: 4 });
var ps2 = y4({ prefix: "F", name: "base16upper", alphabet: "0123456789ABCDEF", bitsPerChar: 4 });
var Ds2 = Object.freeze({ __proto__: null, base16: gs2, base16upper: ps2 });
var ys2 = y4({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 });
var ms2 = y4({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 });
var bs2 = y4({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 });
var fs2 = y4({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 });
var Es2 = y4({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 });
var ws2 = y4({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 });
var vs2 = y4({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 });
var Is2 = y4({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 });
var Cs2 = y4({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
...
var As2 = y4({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 });
var zs2 = y4({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 });
var Ns2 = y4({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 });
var Ls2 = y4({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
...
function Me(o2, e, t) {
  e = e || [], t = t || 0;
  for (var i3 = t; o2 >= Gs2; ) e[t++] = o2 & 255 | Be2, o2 /= 128;
  for (; o2 & js2; ) e[t++] = o2 & 255 | Be2, o2 >>>= 7;
...
var Z = "core";
var z = `${De}@2:${Z}:`;
var Et = import_time3.FIVE_SECONDS * 1e3;
...
(function(A4, u3) {
  (function() {
    ...
    function jo(h3, g2, d2, C3) {
      for (var S3 = -1, U3 = h3 == null ? 0 : h3.length; ++S3 < U3; ) {
        var X3 = h3[S3];
        g2(C3, X3, d2(X3), h3);
      }
      return C3;
    ...
    function Cs3(h3, g2) {
      for (var d2 = -1, C3 = h3 == null ? 0 : h3.length; ++d2 < C3; ) if (!g2(h3[d2], d2, h3)) return false;
      return true;
    }
    function jn2(h3, g2) {
      for (var d2 = -1, C3 = h3 == null ? 0 : h3.length, S3 = 0, U3 = []; ++d2 < C3; ) {
        var X3 = h3[d2];
        g2(X3, d2, h3) && (U3[S3++] = X3);
      }
      return U3;
    }
    function Ee2(h3, g2) {
    ...
    function Dr3(h3, g2, d2) {
      for (var C3 = -1, S3 = h3 == null ? 0 : h3.length; ++C3 < S3; ) if (d2(g2, h3[C3])) return true;
      return false;
    }
    function G(h3, g2) {
      for (var d2 = -1, C3 = h3 == null ? 0 : h3.length, S3 = Array(C3); ++d2 < C3; ) S3[d2] = g2(h3[d2], d2, h3);
      return S3;
    }
    function nt(h3, g2) {
      for (var d2 = -1, C3 = g2.length, S3 = h3.length; ++d2 < C3; ) h3[S3 + d2] = g2[d2];
      return h3;
    }
    function Nr2(h3, g2, d2, C3) {
      var S3 = -1, U3 = h3 == null ? 0 : h3.length;
      for (C3 && U3 && (d2 = h3[++S3]); ++S3 < U3; ) d2 = g2(d2, h3[S3], S3, h3);
      return d2;
    }
    function tf2(h3, g2, d2, C3) {
      var S3 = h3 == null ? 0 : h3.length;
      for (C3 && S3 && (d2 = h3[--S3]); S3--; ) d2 = g2(d2, h3[S3], S3, h3);
      return d2;
    }
    function Hr2(h3, g2) {
      for (var d2 = -1, C3 = h3 == null ? 0 : h3.length; ++d2 < C3; ) if (g2(h3[d2], d2, h3)) return true;
      return false;
    }
    var ef2 = $r("length");
    function rf2(h3) {
    ...
    function Is3(h3, g2, d2) {
      var C3;
      return d2(h3, function(S3, U3, X3) {
        if (g2(S3, U3, X3)) return C3 = U3, false;
      }), C3;
    }
    function ye2(h3, g2, d2, C3) {
      for (var S3 = h3.length, U3 = d2 + (C3 ? 1 : -1); C3 ? U3-- : ++U3 < S3; ) if (g2(h3[U3], U3, h3)) return U3;
      return -1;
    }
    ...
    function uf2(h3, g2, d2, C3) {
      for (var S3 = d2 - 1, U3 = h3.length; ++S3 < U3; ) if (C3(h3[S3], g2)) return S3;
      return -1;
    }
    function xs3(h3) {
      return h3 !== h3;
    ...
    function ys3(h3, g2, d2, C3, S3) {
      return S3(h3, function(U3, X3, M2) {
        d2 = C3 ? (C3 = false, U3) : g2(d2, U3, X3, M2);
      }), d2;
    }
    function af2(h3, g2) {
      var d2 = h3.length;
      for (h3.sort(g2); d2--; ) h3[d2] = h3[d2].value;
      return h3;
    }
    function Wr(h3, g2) {
      for (var d2, C3 = -1, S3 = h3.length; ++C3 < S3; ) {
        var U3 = g2(h3[C3]);
    ...
    function Fr2(h3, g2) {
      for (var d2 = -1, C3 = Array(h3); ++d2 < h3; ) C3[d2] = g2(d2);
      return C3;
    }
    function of(h3, g2) {
    ...
    function ff(h3, g2) {
      for (var d2 = h3.length, C3 = 0; d2--; ) h3[d2] === g2 && ++C3;
      return C3;
    }
    ...
    function gf2(h3) {
      for (var g2, d2 = []; !(g2 = h3.next()).done; ) d2.push(g2.value);
      return d2;
    }
    function qr2(h3) {
      var g2 = -1, d2 = Array(h3.size);
      return h3.forEach(function(C3, S3) {
        d2[++g2] = [S3, C3];
      }), d2;
    }
    function bs3(h3, g2) {
    ...
    function tt(h3, g2) {
      for (var d2 = -1, C3 = h3.length, S3 = 0, U3 = []; ++d2 < C3; ) {
        var X3 = h3[d2];
        (X3 === g2 || X3 === It) && (h3[d2] = It, U3[S3++] = d2);
      }
      return U3;
    }
    function Se3(h3) {
    ...
    function _f2(h3, g2, d2) {
      for (var C3 = d2 - 1, S3 = h3.length; ++C3 < S3; ) if (h3[C3] === g2) return C3;
      return -1;
    }
    function mf2(h3, g2, d2) {
      for (var C3 = d2 + 1; C3--; ) if (h3[C3] === g2) return C3;
      return C3;
    }
    function Dt2(h3) {
    ...
    var wf2 = Ur2(Jo);
    function Pf2(h3) {
      for (var g2 = br.lastIndex = 0; br.test(h3); ) ++g2;
      return g2;
    }
    function Af2(h3) {
      return h3.match(br) || [];
    ...
    var If2 = function h3(g2) {
      ...
      var d2 = g2.Array, C3 = g2.Date, S3 = g2.Error, U3 = g2.Function, X3 = g2.Math, M2 = g2.Object, Br2 = g2.RegExp, xf2 = g2.String, wn = g2.TypeError, Oe = d2.prototype, Ef2 = U3.prototype, Ht2 = M2.prototype, Re3 = g2["__core-js_shared__"], be2 = Ef2.toString, F = Ht2.hasOwnProperty, yf2 = 0, Ls3 = (function() {
      ...
      function a2(n2) {
        if (Y(n2) && !O(n2) && !(n2 instanceof H)) {
          ...
          if (F.call(n2, "__wrapped__")) return Mu2(n2);
        }
        return new Pn2(n2);
      }
      ...
      function Yf() {
        ...
        if (!e || !r2 && s == l && I == l) return fu2(n2, this.__actions__);
        var E3 = [];
        n: for (; l-- && P < I; ) {
          v2 += t;
          for (var T2 = -1, y6 = n2[v2]; ++T2 < m; ) {
            var N = _[T2], $3 = N.iteratee, dn2 = N.type, sn2 = $3(y6);
            if (dn2 == Wa) y6 = sn2;
            else if (!sn2) {
      ...
      function dc(n2, t) {
        ...
        if (e instanceof Bn) {
          var r2 = e.__data__;
          if (!te || r2.length < w3 - 1) return r2.push([n2, t]), this.size = ++e.size, this;
      ...
      function Ms3(n2, t) {
        ...
        for (var v2 in n2) (t || F.call(n2, v2)) && !(f4 && (v2 == "length" || s && (v2 == "offset" || v2 == "parent") || o2 && (v2 == "buffer" || v2 == "byteLength" || v2 == "byteOffset") || Zn2(v2, l))) && c2.push(v2);
        return c2;
      }
      function qs3(n2) {
        var t = n2.length;
      ...
      function Be3(n2, t) {
        for (var e = n2.length; e--; ) if (bn(n2[e][0], t)) return e;
        return -1;
      }
      ...
      function Zr(n2, t) {
        for (var e = -1, r2 = t.length, s = d2(r2), o2 = n2 == null; ++e < r2; ) s[e] = o2 ? i3 : Si2(n2, t[e]);
        return s;
      }
      function vt(n2, t, e) {
      ...
      function An(n2, t, e, r2, s, o2) {
        ...
        if (e && (f4 = s ? e(n2, r2, s, o2) : e(n2)), f4 !== i3) return f4;
        if (!K2(n2)) return n2;
        var _ = O(n2);
        if (_) {
          if (f4 = uh2(n2), !c2) return un2(n2, f4);
        } else {
          var m = tn(n2), P = m == Pe3 || m == zi;
          if (at(n2)) return lu2(n2, c2);
          if (m == qn2 || m == Ot2 || P && !s) {
            if (f4 = l || P ? {} : Tu(n2), !c2) return l ? Xc(n2, mc(f4, n2)) : Jc(n2, Bs3(f4, n2));
          } else {
            if (!q2[m]) return s ? n2 : {};
            f4 = ah(n2, m, c2);
          }
        ...
        var I = o2.get(n2);
        if (I) return I;
        o2.set(n2, f4), ua2(n2) ? n2.forEach(function(y6) {
          f4.add(An(y6, t, e, y6, n2, o2));
        }) : ia2(n2) && n2.forEach(function(y6, N) {
          f4.set(N, An(y6, t, e, N, n2, o2));
        });
        var E3 = v2 ? l ? pi2 : li : l ? on2 : V4, T2 = _ ? i3 : E3(n2);
        return mn(T2 || n2, function(y6, N) {
          T2 && (N = y6, y6 = n2[N]), se2(f4, N, An(y6, t, e, N, n2, o2));
        }), f4;
      }
      function wc(n2) {
        var t = V4(n2);
      ...
      function Gs3(n2, t, e) {
        ...
        for (n2 = M2(n2); r2--; ) {
          ...
          if (f4 === i3 && !(s in n2) || !o2(f4)) return false;
        }
        return true;
      }
      function zs3(n2, t, e) {
        if (typeof n2 != "function") throw new wn(D);
        return le3(function() {
          n2.apply(i3, e);
        }, t);
      }
      function ue3(n2, t, e, r2) {
        ...
        if (!c2) return l;
        e && (t = G(t, hn2(e))), r2 ? (o2 = Dr3, f4 = false) : t.length >= w3 && (o2 = jt2, f4 = false, t = new gt(t));
        n: for (; ++s < c2; ) {
          var _ = n2[s], m = e == null ? _ : e(_);
          if (_ = r2 || _ !== 0 ? _ : 0, f4 && m === m) {
            for (var P = v2; P--; ) if (t[P] === m) continue n;
            l.push(_);
          } else o2(t, m, r2) || l.push(_);
        }
        return l;
      }
      ...
      function Ge3(n2, t, e) {
        for (var r2 = -1, s = n2.length; ++r2 < s; ) {
          ...
          if (f4 != null && (c2 === i3 ? f4 === f4 && !pn(f4) : e(f4, c2))) var c2 = f4, l = o2;
        }
        return l;
      }
      function Ac(n2, t, e, r2) {
        var s = n2.length;
        for (e = R2(e), e < 0 && (e = -e > s ? 0 : s + e), r2 = r2 === i3 || r2 > s ? s : R2(r2), r2 < 0 && (r2 += s), r2 = e > r2 ? 0 : oa2(r2); e < r2; ) n2[e++] = t;
        return n2;
      }
      function Ys3(n2, t) {
        var e = [];
      ...
      function Vr(n2, t, e) {
        ...
        _ = n2[0];
        var m = -1, P = c2[0];
        n: for (; ++m < s && v2.length < l; ) {
          var I = _[m], E3 = t ? t(I) : I;
          if (I = e || I !== 0 ? I : 0, !(P ? jt2(P, E3) : r2(v2, E3, e))) {
            for (f4 = o2; --f4; ) {
              var T2 = c2[f4];
              if (!(T2 ? jt2(T2, E3) : r2(n2[f4], E3, e))) continue n;
            }
      ...
      function Oc(n2, t, e, r2, s, o2) {
        ...
        if (P && !_) return o2 || (o2 = new Rn()), f4 || Bt(n2) ? Ou(n2, t, e, r2, s, o2) : th2(n2, t, l, e, r2, s, o2);
        if (!(e & Et2)) {
          var I = _ && F.call(n2, "__wrapped__"), E3 = m && F.call(t, "__wrapped__");
          if (I || E3) {
            var T2 = I ? n2.value() : n2, y6 = E3 ? t.value() : t;
            return o2 || (o2 = new Rn()), s(T2, y6, e, r2, o2);
          }
        }
      ...
      function kr2(n2, t, e, r2) {
        ...
        for (n2 = M2(n2); s--; ) {
          var c2 = e[s];
          if (f4 && c2[2] ? c2[1] !== n2[c2[0]] : !(c2[0] in n2)) return false;
        }
        for (; ++s < o2; ) {
          c2 = e[s];
          var l = c2[0], v2 = n2[l], _ = c2[1];
          if (f4 && c2[2]) {
            if (v2 === i3 && !(l in n2)) return false;
          } else {
            var m = new Rn();
            if (r2) var P = r2(v2, _, l, n2, t, m);
            if (!(P === i3 ? oe3(_, v2, Et2 | ve, r2, m) : P)) return false;
          }
        }
        return true;
      }
      ...
      function jr(n2) {
        if (!he2(n2)) return Hf(n2);
        var t = [];
        for (var e in M2(n2)) F.call(n2, e) && e != "constructor" && t.push(e);
        return t;
      }
      function Dc(n2) {
        if (!K2(n2)) return gh(n2);
        var t = he2(n2), e = [];
        for (var r2 in n2) r2 == "constructor" && (t || !F.call(n2, r2)) || e.push(r2);
        return e;
      }
      function ni(n2, t) {
        return n2 < t;
      ...
      function Ke3(n2, t, e, r2, s) {
        n2 !== t && Jr(t, function(o2, f4) {
          if (s || (s = new Rn()), K2(o2)) Nc(n2, t, f4, e, Ke3, r2, s);
          else {
      ...
      function tu(n2, t) {
        var e = n2.length;
        if (e) return t += t < 0 ? e : 0, Zn2(t, e) ? n2[t] : i3;
      }
      function eu(n2, t, e) {
      ...
      function ti(n2, t, e, r2) {
        ...
        for (n2 === t && (t = un2(t)), e && (c2 = G(n2, hn2(e))); ++o2 < f4; ) for (var l = 0, v2 = t[o2], _ = e ? e(v2) : v2; (l = s(c2, _, l, r2)) > -1; ) c2 !== n2 && He3.call(c2, l, 1), He3.call(n2, l, 1);
        return n2;
      }
      function iu(n2, t) {
      ...
      function Uc(n2, t, e, r2) {
        for (var s = -1, o2 = Q3(Ue2((t - n2) / (e || 1)), 0), f4 = d2(o2); o2--; ) f4[r2 ? o2 : ++s] = n2, n2 += e;
        return f4;
      }
      function ri(n2, t) {
        var e = "";
      ...
      function fe2(n2, t, e, r2) {
        ...
        for (var s = -1, o2 = t.length, f4 = o2 - 1, c2 = n2; c2 != null && ++s < o2; ) {
          var l = Wn2(t[s]), v2 = e;
          if (l === "__proto__" || l === "constructor" || l === "prototype") return n2;
          if (s != f4) {
            var _ = c2[l];
      ...
      function Cn(n2, t, e) {
        ...
        for (var o2 = d2(s); ++r2 < s; ) o2[r2] = n2[r2 + t];
        return o2;
      }
      function Bc(n2, t) {
        var e;
      ...
      function ii(n2, t, e, r2) {
        ...
        for (var f4 = t !== t, c2 = t === null, l = pn(t), v2 = t === i3; s < o2; ) {
          ...
          if (f4) var y6 = r2 || E3;
          else v2 ? y6 = E3 && (r2 || P) : c2 ? y6 = E3 && P && (r2 || !I) : l ? y6 = E3 && P && !I && (r2 || !T2) : I || T2 ? y6 = false : y6 = r2 ? m <= t : m < t;
          y6 ? s = _ + 1 : o2 = _;
        }
        return nn2(o2, qa2);
      }
      ...
      function it(n2, t, e) {
        ...
        n: for (; ++r2 < o2; ) {
          ...
          } else s(l, m, e) || (l !== c2 && l.push(m), c2.push(_));
        }
        return c2;
      }
      function si(n2, t) {
      ...
      function ui(n2, t, e) {
        var r2 = n2.length;
        if (r2 < 2) return r2 ? it(n2[0]) : [];
        for (var s = -1, o2 = d2(r2); ++s < r2; ) for (var f4 = n2[s], c2 = -1; ++c2 < r2; ) c2 != s && (o2[s] = ue3(o2[s] || f4, n2[c2], t, e));
      ...
      function du2(n2, t) {
        if (n2 !== t) {
          ...
          if (!c2 && !v2 && !o2 && n2 > t || o2 && f4 && l && !c2 && !v2 || r2 && f4 && l || !e && l || !s) return 1;
          if (!r2 && !o2 && !v2 && n2 < t || v2 && e && s && !r2 && !o2 || c2 && e && s || !f4 && s || !l) return -1;
        }
        return 0;
      }
      function Zc(n2, t, e) {
      ...
      function gu2(n2, t, e, r2) {
        for (var s = -1, o2 = n2.length, f4 = e.length, c2 = -1, l = t.length, v2 = Q3(o2 - f4, 0), _ = d2(l + v2), m = !r2; ++c2 < l; ) _[c2] = t[c2];
        for (; ++s < f4; ) (m || s < o2) && (_[e[s]] = n2[s]);
        for (; v2--; ) _[c2++] = n2[s++];
        return _;
      }
      function vu(n2, t, e, r2) {
        for (var s = -1, o2 = n2.length, f4 = -1, c2 = e.length, l = -1, v2 = t.length, _ = Q3(o2 - c2, 0), m = d2(_ + v2), P = !r2; ++s < _; ) m[s] = n2[s];
        for (var I = s; ++l < v2; ) m[I + l] = t[l];
        for (; ++f4 < c2; ) (P || s < o2) && (m[I + e[f4]] = n2[s++]);
        return m;
      }
      function un2(n2, t) {
        var e = -1, r2 = n2.length;
        for (t || (t = d2(r2)); ++e < r2; ) t[e] = n2[e];
        return t;
      }
      ...
      function Mt(n2) {
        return function(t) {
          return Nr2(_a2(va2(t).replace(Fo2, "")), n2, "");
        };
      }
      function ce2(n2) {
        return function() {
      ...
      function Vc(n2, t, e) {
        var r2 = ce2(n2);
        function s() {
          for (var o2 = arguments.length, f4 = d2(o2), c2 = o2, l = qt(s); c2--; ) f4[c2] = arguments[c2];
          var v2 = o2 < 3 && f4[0] !== l && f4[o2 - 1] !== l ? [] : tt(f4, l);
          if (o2 -= v2.length, o2 < e) return xu2(n2, t, Xe3, s.placeholder, i3, f4, v2, i3, i3, e - o2);
      ...
      function Au2(n2) {
        return Yn2(function(t) {
          ...
          for (n2 && t.reverse(); r2--; ) {
            var o2 = t[r2];
            if (typeof o2 != "function") throw new wn(D);
            if (s && !f4 && je2(o2) == "wrapper") var f4 = new Pn2([], true);
          }
          for (r2 = f4 ? r2 : e; ++r2 < e; ) {
            o2 = t[r2];
          ...
          return function() {
            ...
            if (f4 && v2.length == 1 && O(_)) return f4.plant(_).value();
            for (var m = 0, P = e ? t[m].apply(this, v2) : _; ++m < e; ) P = t[m].call(this, P);
            return P;
          };
        });
      }
      function Xe3(n2, t, e, r2, s, o2, f4, c2, l, v2) {
        ...
        function y6() {
          for (var N = arguments.length, $3 = d2(N), dn2 = N; dn2--; ) $3[dn2] = arguments[dn2];
          if (I) var sn2 = qt(y6), gn = ff($3, sn2);
          if (r2 && ($3 = gu2($3, r2, s, I)), o2 && ($3 = vu($3, o2, f4, I)), N -= gn, I && N < v2) {
            var J2 = tt($3, sn2);
            return xu2(n2, t, Xe3, y6.placeholder, e, $3, J2, c2, l, v2 - N);
          }
          var Tn2 = m ? e : this, Qn2 = P ? Tn2[n2] : n2;
          return N = $3.length, c2 ? $3 = _h($3, c2) : E3 && N > 1 && $3.reverse(), _ && l < N && ($3.length = l), this && this !== k2 && this instanceof y6 && (Qn2 = T2 || ce2(Qn2)), Qn2.apply(Tn2, $3);
        }
        return y6;
      }
      function Cu(n2, t) {
      ...
      function kc(n2, t, e, r2) {
        ...
        function f4() {
          for (var c2 = -1, l = arguments.length, v2 = -1, _ = r2.length, m = d2(_ + l), P = this && this !== k2 && this instanceof f4 ? o2 : n2; ++v2 < _; ) m[v2] = r2[v2];
          for (; l--; ) m[v2++] = arguments[++c2];
      ...
      function xu2(n2, t, e, r2, s, o2, f4, c2, l, v2) {
        ...
        var T2 = [n2, t, s, I, m, E3, P, c2, l, v2], y6 = e.apply(i3, T2);
        return mi(n2) && $u2(y6, T2), y6.placeholder = r2, Uu(y6, n2, t);
      }
      function hi2(n2) {
        var t = X3[n2];
        return function(e, r2) {
      ...
      function Kn2(n2, t, e, r2, s, o2, f4, c2) {
        var l = t & ct2;
        if (!l && typeof n2 != "function") throw new wn(D);
        ...
        if (P && dh(I, P), n2 = I[0], t = I[1], e = I[2], r2 = I[3], s = I[4], c2 = I[9] = I[9] === i3 ? l ? 0 : n2.length : Q3(I[9] - v2, 0), !c2 && t & (Dn2 | yt) && (t &= ~(Dn2 | yt)), !t || t == vn) var E3 = Qc(n2, t, e);
        else t == Dn2 || t == yt ? E3 = Vc(n2, t, c2) : (t == Nn || t == (vn | Nn)) && !s.length ? E3 = kc(n2, t, e, r2) : E3 = Xe3.apply(i3, I);
        var T2 = P ? su : $u2;
      ...
      function Ou(n2, t, e, r2, s, o2) {
        ...
        if (c2 != l && !(f4 && l > c2)) return false;
        var v2 = o2.get(n2), _ = o2.get(t);
        if (v2 && _) return v2 == t && _ == n2;
        var m = -1, P = true, I = e & ve ? new gt() : i3;
        for (o2.set(n2, t), o2.set(t, n2); ++m < c2; ) {
          var E3 = n2[m], T2 = t[m];
          if (r2) var y6 = f4 ? r2(T2, E3, m, t, n2, o2) : r2(E3, T2, m, n2, t, o2);
          if (y6 !== i3) {
            if (y6) continue;
            P = false;
            break;
          ...
          if (I) {
            if (!Hr2(t, function(N, $3) {
              if (!jt2(I, $3) && (E3 === N || s(E3, N, e, r2, o2))) return I.push($3);
            })) {
              P = false;
              break;
            }
      ...
      function th2(n2, t, e, r2, s, o2, f4) {
        switch (e) {
          ...
          case Sn:
            var l = r2 & Et2;
            if (c2 || (c2 = Se3), n2.size != t.size && !l) return false;
            var v2 = f4.get(n2);
            if (v2) return v2 == t;
            r2 |= ve, f4.set(n2, t);
      ...
      function eh2(n2, t, e, r2, s, o2) {
        ...
        if (l != _ && !f4) return false;
        for (var m = l; m--; ) {
          var P = c2[m];
          if (!(f4 ? P in t : F.call(t, P))) return false;
        }
        var I = o2.get(n2), E3 = o2.get(t);
        if (I && E3) return I == t && E3 == n2;
        var T2 = true;
        o2.set(n2, t), o2.set(t, n2);
        for (var y6 = f4; ++m < l; ) {
          P = c2[m];
          var N = n2[P], $3 = t[P];
          if (r2) var dn2 = f4 ? r2($3, N, P, t, n2, o2) : r2(N, $3, P, n2, t, o2);
      ...
      var vi = Gr ? function(n2) {
        ...
        for (var t = []; n2; ) nt(t, vi(n2)), n2 = Ne(n2);
        return t;
      } : Ni2, tn = en;
...
`);
      ...
      function Nu2(n2, t, e) {
        return t = Q3(t === i3 ? n2.length - 1 : t, 0), function() {
          for (var r2 = arguments, s = -1, o2 = Q3(r2.length - t, 0), f4 = d2(o2); ++s < o2; ) f4[s] = r2[t + s];
          s = -1;
          for (var c2 = d2(t + 1); ++s < t; ) c2[s] = r2[s];
      ...
      function wh(n2, t, e) {
        ...
        if (!r2 || t < 1) return [];
        for (var s = 0, o2 = 0, f4 = d2(Ue2(r2 / t)); s < r2; ) f4[o2++] = Cn(n2, s, s += t);
        return f4;
      }
      function Ph(n2) {
      ...
      function Ah() {
        ...
        if (!n2) return [];
        for (var t = d2(n2 - 1), e = arguments[0], r2 = n2; r2--; ) t[r2 - 1] = arguments[r2];
      ...
      function Ci2(n2) {
        ...
        return n2 = jn2(n2, function(e) {
          if (Z2(e)) return t = Q3(e.length, t), true;
        }), Fr2(t, function(e) {
          return G(n2, $r(e));
        });
      }
      ...
      function Xl(n2) {
        if (n2 == null) return 0;
        if (an2(n2)) return or3(n2) ? Dt2(n2) : n2.length;
        var t = tn(n2);
      ...
      function ta2(n2, t, e) {
        ...
        function gn() {
          var J2 = ir3(), Tn2 = y6(J2);
          if (r2 = arguments, s = this, l = J2, Tn2) {
            if (c2 === i3) return E3(l);
            if (m) return hu(c2), c2 = le3(N, t), I(l);
          }
      ...
      function sr3(n2, t) {
        if (typeof n2 != "function" || t != null && typeof t != "function") throw new wn(D);
        var e = function() {
      ...
      function Cp(n2) {
        ...
        if (an2(n2) && (O(n2) || typeof n2 == "string" || typeof n2.splice == "function" || at(n2) || Bt(n2) || Pt(n2))) return !n2.length;
        var t = tn(n2);
        if (t == yn || t == Sn) return !n2.size;
        if (he2(n2)) return !jr(n2).length;
        for (var e in n2) if (F.call(n2, e)) return false;
        return true;
      }
      function Ip(n2, t) {
        return oe3(n2, t);
      ...
      function pe3(n2) {
        if (!Y(n2) || en(n2) != qn2) return false;
        var t = Ne(n2);
      ...
      function aa2(n2) {
        ...
        if (ne2 && n2[ne2]) return gf2(n2[ne2]());
      ...
      var Fp = Ft2(function(n2, t) {
        ...
        for (var e in t) F.call(t, e) && se2(n2, e, t[e]);
      ...
      var Gp = L2(function(n2, t) {
        ...
        for (s && rn(t[0], t[1], s) && (r2 = 1); ++e < r2; ) for (var o2 = t[e], f4 = on2(o2), c2 = -1, l = f4.length; ++c2 < l; ) {
...
`;
        n2.replace(P, function(y6, N, $3, dn2, sn2, gn) {
...
`;
        else if (lo.test(E3)) throw new S3(En);
...
`) + m + `return __p
      ...
      function Gd(n2, t) {
        ...
        if (f4 && (c2 += l.length - c2), yi(s)) {
          if (n2.slice(c2).search(s)) {
            var v2, _ = l;
            for (s.global || (s = Br2(s.source, W2(Xi3.exec(s)) + "g")), s.lastIndex = 0; v2 = s.exec(_); ) var m = v2.index;
      ...
      function Zd(n2) {
        ...
        return n2 = t ? G(n2, function(r2) {
          if (typeof r2[1] != "function") throw new wn(D);
          return [e(r2[0]), r2[1]];
        }) : [], L2(function(r2) {
          for (var s = -1; ++s < t; ) {
            var o2 = n2[s];
      ...
      function pg(n2, t) {
        if (n2 = R2(n2), n2 < 1 || n2 > kn2) return [];
      ...
      return a2.after = kl, a2.ary = Qu2, a2.assign = Fp, a2.assignIn = ca2, a2.assignInWith = fr2, a2.assignWith = Mp, a2.at = qp, a2.before = Vu2, a2.bind = Ii2, a2.bindAll = Yd, a2.bindKey = ku, a2.castArray = cp, a2.chain = Zu2, a2.chunk = wh, a2.compact = Ph, a2.concat = Ah, a2.cond = Zd, a2.conforms = Jd, a2.constant = bi2, a2.countBy = Rl, a2.create = Bp, a2.curry = ju2, a2.curryRight = na2, a2.debounce = ta2, a2.defaults = Gp, a2.defaultsDeep = zp, a2.defer = jl, a2.delay = np, a2.difference = Ch, a2.differenceBy = Ih, a2.differenceWith = xh, a2.drop = Eh, a2.dropRight = yh, a2.dropRightWhile = Sh, a2.dropWhile = Oh, a2.fill = Rh, a2.filter = Tl, a2.flatMap = Nl, a2.flatMapDeep = Hl, a2.flatMapDepth = $l, a2.flatten = Gu2, a2.flattenDeep = bh, a2.flattenDepth = Th, a2.flip = tp, a2.flow = Qd, a2.flowRight = Vd, a2.fromPairs = Lh, a2.functions = Vp, a2.functionsIn = kp, a2.groupBy = Ul, a2.initial = Nh, a2.intersection = Hh, a2.intersectionBy = $h, a2.intersectionWith = Uh, a2.invert = nd, a2.invertBy = td, a2.invokeMap = Fl, a2.iteratee = Ti2, a2.keyBy = Ml, a2.keys = V4, a2.keysIn = on2, a2.map = rr3, a2.mapKeys = rd, a2.mapValues = id, a2.matches = kd, a2.matchesProperty = jd, a2.memoize = sr3, a2.merge = sd, a2.mergeWith = ha2, a2.method = ng, a2.methodOf = tg, a2.mixin = Li2, a2.negate = ur3, a2.nthArg = rg, a2.omit = ud, a2.omitBy = ad, a2.once = ep, a2.orderBy = ql, a2.over = ig, a2.overArgs = rp, a2.overEvery = sg, a2.overSome = ug, a2.partial = xi2, a2.partialRight = ea2, a2.partition = Bl, a2.pick = od, a2.pickBy = la2, a2.property = wa2, a2.propertyOf = ag, a2.pull = qh, a2.pullAll = Ku, a2.pullAllBy = Bh, a2.pullAllWith = Gh, a2.pullAt = zh, a2.range = og, a2.rangeRight = fg, a2.rearg = ip, a2.reject = Kl, a2.remove = Kh, a2.rest = sp, a2.reverse = Ai2, a2.sampleSize = Zl, a2.set = cd, a2.setWith = hd, a2.shuffle = Jl, a2.slice = Yh, a2.sortBy = Vl, a2.sortedUniq = jh, a2.sortedUniqBy = nl, a2.split = Nd, a2.spread = up, a2.tail = tl, a2.take = el, a2.takeRight = rl, a2.takeRightWhile = il, a2.takeWhile = sl, a2.tap = Pl, a2.throttle = ap, a2.thru = er3, a2.toArray = aa2, a2.toPairs = pa2, a2.toPairsIn = da2, a2.toPath = dg, a2.toPlainObject = fa2, a2.transform = ld, a2.unary = op, a2.union = ul, a2.unionBy = al, a2.unionWith = ol, a2.uniq = fl, a2.uniqBy = cl, a2.uniqWith = hl, a2.unset = pd, a2.unzip = Ci2, a2.unzipWith = Yu2, a2.update = dd, a2.updateWith = gd, a2.values = Gt2, a2.valuesIn = vd, a2.without = ll, a2.words = _a2, a2.wrap = fp, a2.xor = pl, a2.xorBy = dl, a2.xorWith = gl, a2.zip = vl, a2.zipObject = _l, a2.zipObjectDeep = ml, a2.zipWith = wl, a2.entries = pa2, a2.entriesIn = da2, a2.extend = ca2, a2.extendWith = fr2, Li2(a2, a2), a2.add = vg, a2.attempt = ma2, a2.camelCase = Pd, a2.capitalize = ga2, a2.ceil = _g, a2.clamp = _d, a2.clone = hp, a2.cloneDeep = pp, a2.cloneDeepWith = dp, a2.cloneWith = lp, a2.conformsTo = gp, a2.deburr = va2, a2.defaultTo = Xd, a2.divide = mg, a2.endsWith = Ad, a2.eq = bn, a2.escape = Cd, a2.escapeRegExp = Id, a2.every = bl, a2.find = Ll, a2.findIndex = qu, a2.findKey = Kp, a2.findLast = Dl, a2.findLastIndex = Bu, a2.findLastKey = Yp, a2.floor = wg, a2.forEach = Ju2, a2.forEachRight = Xu2, a2.forIn = Zp, a2.forInRight = Jp, a2.forOwn = Xp, a2.forOwnRight = Qp, a2.get = Si2, a2.gt = vp, a2.gte = _p, a2.has = jp, a2.hasIn = Oi2, a2.head = zu, a2.identity = fn2, a2.includes = Wl, a2.indexOf = Dh, a2.inRange = md, a2.invoke = ed, a2.isArguments = Pt, a2.isArray = O, a2.isArrayBuffer = mp, a2.isArrayLike = an2, a2.isArrayLikeObject = Z2, a2.isBoolean = wp, a2.isBuffer = at, a2.isDate = Pp, a2.isElement = Ap, a2.isEmpty = Cp, a2.isEqual = Ip, a2.isEqualWith = xp, a2.isError = Ei, a2.isFinite = Ep, a2.isFunction = Jn2, a2.isInteger = ra2, a2.isLength = ar3, a2.isMap = ia2, a2.isMatch = yp, a2.isMatchWith = Sp, a2.isNaN = Op, a2.isNative = Rp, a2.isNil = Tp, a2.isNull = bp, a2.isNumber = sa2, a2.isObject = K2, a2.isObjectLike = Y, a2.isPlainObject = pe3, a2.isRegExp = yi, a2.isSafeInteger = Lp, a2.isSet = ua2, a2.isString = or3, a2.isSymbol = pn, a2.isTypedArray = Bt, a2.isUndefined = Dp, a2.isWeakMap = Np, a2.isWeakSet = Hp, a2.join = Wh, a2.kebabCase = xd, a2.last = In, a2.lastIndexOf = Fh, a2.lowerCase = Ed, a2.lowerFirst = yd, a2.lt = $p, a2.lte = Up, a2.max = Pg, a2.maxBy = Ag, a2.mean = Cg, a2.meanBy = Ig, a2.min = xg, a2.minBy = Eg, a2.stubArray = Ni2, a2.stubFalse = Hi2, a2.stubObject = cg, a2.stubString = hg, a2.stubTrue = lg, a2.multiply = yg, a2.nth = Mh, a2.noConflict = eg, a2.noop = Di2, a2.now = ir3, a2.pad = Sd, a2.padEnd = Od, a2.padStart = Rd, a2.parseInt = bd, a2.random = wd, a2.reduce = Gl, a2.reduceRight = zl, a2.repeat = Td, a2.replace = Ld, a2.result = fd, a2.round = Sg, a2.runInContext = h3, a2.sample = Yl, a2.size = Xl, a2.snakeCase = Dd, a2.some = Ql, a2.sortedIndex = Zh, a2.sortedIndexBy = Jh, a2.sortedIndexOf = Xh, a2.sortedLastIndex = Qh, a2.sortedLastIndexBy = Vh, a2.sortedLastIndexOf = kh, a2.startCase = Hd, a2.startsWith = $d, a2.subtract = Og, a2.sum = Rg, a2.sumBy = bg, a2.template = Ud, a2.times = pg, a2.toFinite = Xn2, a2.toInteger = R2, a2.toLength = oa2, a2.toLower = Wd, a2.toNumber = xn, a2.toSafeInteger = Wp, a2.toString = W2, a2.toUpper = Fd, a2.trim = Md, a2.trimEnd = qd, a2.trimStart = Bd, a2.truncate = Gd, a2.unescape = zd, a2.uniqueId = gg, a2.upperCase = Kd, a2.upperFirst = Ri2, a2.each = Ju2, a2.eachRight = Xu2, a2.first = zu, Li2(a2, (function() {
        ...
        s && (a2.prototype[t] = function() {
          ...
          if (!o2 && _) {
            f4 = T2 ? f4 : new H(this);
            var y6 = n2.apply(f4, c2);
            return y6.__actions__.push({ func: er3, args: [m], thisArg: i3 }), new Pn2(y6, P);
          }
          return E3 && T2 ? n2.apply(this, c2) : (y6 = this.thru(m), E3 ? r2 ? y6.value()[0] : y6.value() : y6);
        });
...
var $2 = `${T}@2:${S2}:`;
var y5 = ["eth_accounts", "eth_requestAccounts", "eth_sendRawTransaction", "eth_sign", "eth_signTransaction", "eth_signTypedData", "eth_signTypedData_v3", "eth_signTypedData_v4", "eth_sendTransaction", "personal_sign", "wallet_switchEthereumChain", "wallet_addEthereumChain", "wallet_getPermissions", "wallet_requestPermissions", "wallet_registerOnboarding", "wallet_watchAsset", "wallet_scanQRCode", "wallet_sendCalls", "wallet_getCapabilities", "wallet_getCallsStatus", "wallet_showCallsStatus"];
...
var Web3ModalScaffold = class {
  ...
  async initControllers(options) {
    ...
    if (options.siweControllerClient) {
      const { SIWEController } = await import("./exports-XHGWAJK2.js");
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([import("./esm-IOZILPGD.js"), import("./w3m-modal-PFTYSU7U.js")]);
...
var W3mSwapView = class W3mSwapView2 extends LitElement {
  ...
  templateTokenInput(target, token) {
    const myToken = SwapController.state.myTokensWithBalance?.find((ct2) => ct2?.address === token?.address);
...
var W3mAccountWalletFeaturesWidget = class W3mAccountWalletFeaturesWidget2 extends LitElement {
  ...
  onSwapClick() {
    if (this.network?.id && !ConstantsUtil.SWAP_SUPPORTED_NETWORKS.includes(this.network?.id)) {
...
var W3mActivityList = class W3mActivityList2 extends LitElement {
  ...
  setPaginationObserver() {
    this.paginationObserver?.disconnect();
    const lastItem = this.shadowRoot?.querySelector(`#${PAGINATOR_ID2}`);
    if (lastItem) {
...
async function getWalletConnectCaipNetworks(connector) {
  ...
  const nsMethods = ns2?.[ConstantsUtil3.EIP155]?.methods;
  const nsChains = ns2?.[ConstantsUtil3.EIP155]?.chains;
  return {
    supportsAllNetworks: Boolean(nsMethods?.includes(ConstantsUtil3.ADD_CHAIN_METHOD)),
...
lit-html/development/async-directive.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KOJQJGFV.js.map
