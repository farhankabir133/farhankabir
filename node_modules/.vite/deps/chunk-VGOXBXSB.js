...
var ICONS = {
  add: async () => (await import("./add-ZXEVTXVI.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-3IL6GD2M.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-6O35HG3X.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-5AATI477.js")).appStoreSvg,
  apple: async () => (await import("./apple-JJABQEFB.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-EVPD67EJ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-EED7QHPP.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-7UG2AA7E.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-LBTOT6VM.js")).arrowTopSvg,
  bank: async () => (await import("./bank-VCSAPK4O.js")).bankSvg,
  browser: async () => (await import("./browser-YE6XYQJ6.js")).browserSvg,
  card: async () => (await import("./card-YU2IMWPJ.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-4FF76T43.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-D2PMEMOY.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-S7FDKXGA.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-5PF75GA5.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-ZKWXVQKR.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-CS6QHG7N.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-R56646EU.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-CVK7PX5S.js")).clockSvg,
  close: async () => (await import("./close-LSXHVHXL.js")).closeSvg,
  compass: async () => (await import("./compass-V6PXMTSO.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-LKJVBVNS.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-T7HB2XUV.js")).copySvg,
  cursor: async () => (await import("./cursor-Z46MOMNI.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-ONDFZHHH.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-PUTQY7RV.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-LSJDKOKX.js")).disconnectSvg,
  discord: async () => (await import("./discord-P2NVB7SH.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-DZ2HCWNQ.js")).etherscanSvg,
  extension: async () => (await import("./extension-KXP5DCFY.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-JTWDZTEF.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-7AA4BEJW.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-BZ5QGVCE.js")).farcasterSvg,
  filters: async () => (await import("./filters-BCG6WSST.js")).filtersSvg,
  github: async () => (await import("./github-42O3YBKD.js")).githubSvg,
  google: async () => (await import("./google-KLJPSZBG.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-N4YLKXDI.js")).helpCircleSvg,
  image: async () => (await import("./image-6RGUZ6KQ.js")).imageSvg,
  id: async () => (await import("./id-YKBA2NC3.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-XOBKGT4F.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-5JS2MEUO.js")).lightbulbSvg,
  mail: async () => (await import("./mail-GRBYMLNF.js")).mailSvg,
  mobile: async () => (await import("./mobile-AIMIQCRS.js")).mobileSvg,
  more: async () => (await import("./more-O2PJRX5W.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-25BWP2QM.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-NLH6R6XH.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-7UHUYUWS.js")).offSvg,
  playStore: async () => (await import("./play-store-U3T2JODI.js")).playStoreSvg,
  plus: async () => (await import("./plus-OQB6NK57.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-ONG2RGRD.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-BG3LHFXW.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-KVWLWA76.js")).refreshSvg,
  search: async () => (await import("./search-DVNPTEUU.js")).searchSvg,
  send: async () => (await import("./send-4SSCF7X7.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-YK7BYZ7W.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-PJJHJ6VH.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-Y5G64V5S.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-GIYHSSQC.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-X6S3OPVU.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-G7ZDV57L.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-MMMPRRTG.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-PISSHR45.js")).twitchSvg,
  twitter: async () => (await import("./x-3KLWY4TA.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-QVBDJ6Y5.js")).twitterIconSvg,
  verify: async () => (await import("./verify-UY67RCBR.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-M5C3NLPW.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-X52CCVP4.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-AKJWWEUL.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-AKJWWEUL.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-AKJWWEUL.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-IEAAUGNA.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-CXWV7JYE.js")).warningCircleSvg,
  x: async () => (await import("./x-3KLWY4TA.js")).xSvg,
  info: async () => (await import("./info-5UF2F4HG.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-55AGUL4J.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-IRHSL4WU.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VGOXBXSB.js.map
