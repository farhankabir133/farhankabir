...
var Web3ModalScaffold = class {
  ...
  async initControllers(options) {
    ...
    if (options.siweControllerClient) {
      const { SIWEController } = await import("./exports-UXD42WQP.js");
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([import("./esm-IOZILPGD.js"), import("./w3m-modal-S2RWXTEJ.js")]);
...
@walletconnect/universal-provider/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-W2T7D5AI.js.map
